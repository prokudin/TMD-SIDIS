...
\Bernie{This assumption holds if renormalization is multiplicative and
   ...
   not true for all lattice actions \cite{Yoon:2017qzo}. %PhysRevD.96.094508
   % NOT \cite{Musch:2010ka}.
...
(e.g.\ for common values of $x$ the $Q^2$ at COMPASS is only about \gs{a factor 2-3} 
...
\gs{covering kinematic regions that vary by orders of magnitude in $Q^2$.}}}
...
% The first polarized Drell--Yan data were measured by 
% COMPASS~\cite{Aghasyan:2017jop,Parsamyan:2018zju}.
...
\caption{\label{altcos2phihphis} $A_{LT}^{\cos(2\phi_h - \phi_S)}$
	...
	\ps{shown separately for reasons explained in the
	caption \gs{of} Fig.~\ref{aut_h1tp_jlab}.}}
	% The smallness of this asymmetry has two natural reasons: first, 
    	% being twist-3 it is $M_N/Q$ suppressed; and second, it is 
	% proportional to $P_{hT}^2$  in TMD approach.
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
structure functions up to twist-3 % in a unique approach. 
