...
can be tested by data from COMPASS, HERMES, Jefferson Lab, and the future
...
\begin{subequations}\ba\hspace{-1cm}
   ...
   =	% \frac{1}{4\pi}\;\frac{d \hat{\sigma}}{dy}
...
\ba
&& \omega^{\{0\}}  	= 1 \, , \nonumber\\
&& \omega^{\{1\}}_{\rm A} 	= \frac{\bfhp\cdot\bfpperp^{ }}{z \mh}  \, , \;\;\;
   \omega^{\{1\}}_{\rm B} 	= \frac{\bfhp\cdot\bfkperp^{ }}{M_N}\,,\nonumber\\
&& \omega^{\{2\}}_{\rm A} 	=  \frac{2\, \bigl(\bfhp\cdot\bfpperp^{ }\bigr)\,
			\bigl(\bfhp\cdot\bfkperp^{ }\bigr)}{zM_N\mh}\,,\;\;\;
   \omega^{\{2\}}_{\rm B}	= -\frac{\bfpperp^{ }\cdot\bfkperp^{ }}{zM_N\mh}\,,\;\;\;
...
The structure functions that survive $\Phperp$--integration of the SIDIS cross section in
...
\begin{subequations}\ba
	...
	\label{Eq:FLT-collinear}\\
	 F_{UT}^{\sin\phi_S}(x,z) &=& -\,\frac{2\,\mh}{Q}\; x\sum_a e_a^2\,
...
\centering
\begin{tabular}{cc}
\includegraphics[height=3.5cm]{\FigPath/UT_Pr10_pretzelosity_pip.pdf}{\tiny(a)}&
\includegraphics[height=3.4cm]{\FigPath/AUTPretzelosity_HERMES_x.pdf}{\tiny(c)}
\\
\includegraphics[height=3.5cm]{\FigPath/UT_Pr10_pretzelosity_pim.pdf}{\tiny(b)}&
\includegraphics[height=3.4cm]{\FigPath/AUTPretzelosity_x.pdf}{\tiny(d)}
\end{tabular}
...
% \ps{A notable exception is COMPASS, where the largest $x$--bins
...
\includegraphics[width=0.31\textwidth]{\FigPath/LT_Pr10_cosphihphis_pip}&
\ \hspace{-3mm}
\includegraphics[width=0.31\textwidth]{\FigPath/LT_Pr10_cosphihphis_pim}&
\ \hspace{-3mm}
\includegraphics[width=0.36\textwidth]{\FigPath/ALT_COMPASS_x.pdf} \\[-3mm]
 {\tiny (a)}&~~~~{\tiny (b)}&~~~~~~{\tiny (c)}
\end{tabular}
...
\includegraphics[height=5cm]{\FigPath/A_UL2_Pr0711_Zgt02.pdf} \\
...
\includegraphics[height=3.6cm]{\FigPath/AULsin2phi_JLAB_x.pdf} \
\includegraphics[height=3.6cm]{\FigPath/AULsin2phi_COMPASS_x} \\
...
$\tilde{G}^{\perp a}$ and $\tilde{E}^a$; % and neglected here; 
the other two
...
\centering
\begin{tabular}{ccc} \ \hspace{-8mm}
\includegraphics[height=3.3cm]{\FigPath/LT_Pr10_cosphis_pip.pdf}&
\includegraphics[height=3.3cm]{\FigPath/LT_Pr10_cosphis_pim.pdf}&
\includegraphics[height=3.1cm]{\FigPath/ALTcosPhi_COMPASS_x}\\
{\tiny(a)}& {\tiny(b)}& {\tiny(c)}
\end{tabular}
...
\centering
\begin{tabular}{ccc} \ \hspace{-8mm}
\includegraphics[width=0.30\textwidth]{\FigPath/LT_Pr10_cos2phihphis_pip}&
\includegraphics[width=0.30\textwidth]{\FigPath/LT_Pr10_cos2phihphis_pim}&
\includegraphics[width=0.36\textwidth]{\FigPath/ALTcos2PhiminusPhiS_COMPASS_x}\\
{\tiny(a)}& {\tiny(b)}& {\tiny(c)}
\end{tabular}
...
\includegraphics[width=0.6\textwidth]{\FigPath/A_LL_Pr0711_Zgt02.pdf}&
\includegraphics[width=0.38\textwidth]{\FigPath/ALLcosphi_COMPASS_x}\\
...
\centering
\begin{tabular}{cc} \ \hspace{-8mm}
\includegraphics[width=0.38\textwidth]{\FigPath/AULsinphi_HERMES_x.pdf} &
\includegraphics[width=0.38\textwidth]{\FigPath/AULsinphi_JLAB_x.pdf} \\
{\tiny (a) }&{\tiny (b)} \vspace{5mm}\\
\ \hspace{-8mm}
\includegraphics[width=0.6\textwidth]{\FigPath/A_UL1_Pr0711_Zgt02.pdf}&
\includegraphics[width=0.38\textwidth]{\FigPath/AULsinphi_COMPASS_x.pdf}\\
...
\centering
\begin{tabular}{ccc} \ \hspace{-8mm}
\includegraphics[height=3.3cm]{\FigPath/UT_Pr10_sinphis_pip.pdf}&
\includegraphics[height=3.3cm]{\FigPath/UT_Pr10_sinphis_pim.pdf}&
%\includegraphics[height=2.7cm]{\FigPath/AUTsinphiS_COMPASS_x}  
\includegraphics[height=3.3cm]{\FigPath/AUTsinphiS_HERMES_x.pdf}\\
{\tiny (a)}&{\tiny (b)}&{\tiny (c)}
\end{tabular}
\caption{\label{autsinphis}
	...
	% \ps{our calculation for COMPASS kinematics (c),}
...
\begin{figure}[t!]
\centering
\includegraphics[height=3.1cm]{\FigPath/UT_Pr10_sin2phihphis_pip} {\tiny (a)}%
\includegraphics[height=3.1cm]{\FigPath/UT_Pr10_sin2phihphis_pip} {\tiny (b)}

\includegraphics[height=2.4cm]{\FigPath/AUTsin2PhiminusPhiS_COMPASS_x} {\tiny (c)}
\includegraphics[height=2.4cm]{\FigPath/AUTsin2PhiminusPhiS_HERMES_x.pdf} {\tiny (d)}
...
\begin{figure}[t!]
\centering
\includegraphics[width=0.38\textwidth]{\FigPath/AUUcosphi_COMPASS_x.pdf}
\includegraphics[width=0.38\textwidth]{\FigPath/AUUcosphi_HERMES_x.pdf}
...
\begin{subequations}\label{Eq:Gaussian-integrals-RAW}\ba
  ...
  {\cal C}\bigl[ \omega^{\{1\}}_{\rm A} \, f \, D \bigr]
    &=&	\phantom{-}\,u \;{\cal G}(\Phperp)\;
	\biggl(\frac{z\Phperp}{\mh}\biggr)\;\frac{\la\pperp^2\ra}{z^2\lambda}\\
  ...
  {\cal C}\bigl[ \omega^{\{2\}}_{\rm A} \, f \, D \bigr]
    &=&	\phantom{-}\,u \; {\cal G}(\Phperp)\;
	\frac{\la\kperp^2\ra\la\pperp^2\ra}{\lambda M_N \mh}
...
was chosen to display the pattern. The masses $M_N$ or $\mh$ in the
...
A.~Kotzinian, \emph{{New quark distributions and semiinclusive
  electroproduction on the polarized nucleons}},
  \href{http://dx.doi.org/10.1016/0550-3213(95)00098-D}{\emph{Nucl. Phys.} {\bf
  B441} (1995) 234--248}, [\href{https://arxiv.org/abs/hep-ph/9412283}{{\tt
  hep-ph/9412283}}].

\bibitem{Mulders:1995dh}
P.~J. Mulders and R.~D. Tangerman, \emph{{The complete tree-level result up to
  order 1/Q for polarized deep-inelastic leptoproduction}},
  \href{http://dx.doi.org/10.1016/0550-3213(95)00632-X}{\emph{Nucl. Phys.} {\bf
  B461} (1996) 197--237}, [\href{https://arxiv.org/abs/hep-ph/9510301}{{\tt
  hep-ph/9510301}}].

\bibitem{Boer:1997nt}
D.~Boer and P.~J. Mulders, \emph{{Time-reversal odd distribution functions in
  leptoproduction}},
  \href{http://dx.doi.org/10.1103/PhysRevD.57.5780}{\emph{Phys. Rev.} {\bf D57}
  (1998) 5780--5786}, [\href{https://arxiv.org/abs/hep-ph/9711485}{{\tt
  hep-ph/9711485}}].

\bibitem{Goeke:2005hb}
K.~Goeke, A.~Metz and M.~Schlegel, \emph{{Parameterization of the quark--quark
  correlator of a spin-1/2 hadron}},
  \href{http://dx.doi.org/10.1016/j.physletb.2005.05.037}{\emph{Phys. Lett.}
  {\bf B618} (2005) 90--96}, [\href{https://arxiv.org/abs/hep-ph/0504130}{{\tt
  hep-ph/0504130}}].

\bibitem{Bacchetta:2006tn}
A.~Bacchetta, M.~Diehl, K.~Goeke, A.~Metz, P.~J. Mulders and M.~Schlegel,
  \emph{{Semi-inclusive deep inelastic scattering at small transverse
  momentum}},
  \href{http://dx.doi.org/10.1088/1126-6708/2007/02/093}{\emph{JHEP} {\bf 02}
  (2007) 093}, [\href{https://arxiv.org/abs/hep-ph/0611265}{{\tt
  hep-ph/0611265}}].

\bibitem{Stock:1994vv}
F.~Stock et~al., \emph{{The FILTEX / HERMES polarized hydrogen atomic beam
  source}}, \href{http://dx.doi.org/10.1016/0168-9002(94)90210-0}{\emph{Nucl.
  Instrum. Meth.} {\bf A343} (1994) 334--342}.

\bibitem{Airapetian:2004yf}
{\scshape HERMES} collaboration, A.~Airapetian et~al., \emph{{The HERMES
  polarized hydrogen and deuterium gas target in the HERA electron storage
  ring}}, \href{http://dx.doi.org/10.1016/j.nima.2004.11.020}{\emph{Nucl.
  Instrum. Meth.} {\bf A540} (2005) 68--101},
  [\href{https://arxiv.org/abs/physics/0408137}{{\tt physics/0408137}}].

\bibitem{Crabb:1997cy}
D.~G. Crabb and W.~Meyer, \emph{{Solid polarized targets for nuclear and
  particle physics experiments}},
  \href{http://dx.doi.org/10.1146/annurev.nucl.47.1.67}{\emph{Ann. Rev. Nucl.
  Part. Sci.} {\bf 47} (1997) 67--109}.

\bibitem{Goertz:2002vv}
S.~Goertz, W.~Meyer and G.~Reicherz, \emph{{Polarized H, D and $^{3}$He targets
  for particle physics experiments}},
  \href{http://dx.doi.org/10.1016/S0146-6410(02)00159-X}{\emph{Prog. Part.
  Nucl. Phys.} {\bf 49} (2002) 403--489}.

\bibitem{Arnold:2008kf}
S.~Arnold, A.~Metz and M.~Schlegel, \emph{{Dilepton production from polarized
  hadron hadron collisions}},
  \href{http://dx.doi.org/10.1103/PhysRevD.79.034005}{\emph{Phys. Rev.} {\bf
  D79} (2009) 034005}, [\href{https://arxiv.org/abs/0809.2262}{{\tt
  0809.2262}}].

\bibitem{Metz:2016swz}
A.~Metz and A.~Vossen, \emph{{Parton fragmentation functions}},
  \href{http://dx.doi.org/10.1016/j.ppnp.2016.08.003}{\emph{Prog. Part. Nucl.
  Phys.} {\bf 91} (2016) 136--202},
  [\href{https://arxiv.org/abs/1607.02521}{{\tt 1607.02521}}].

\bibitem{Miller:2007ae}
G.~A. Miller, \emph{{Densities, parton distributions, and measuring the
  nonspherical shape of the nucleon}},
  \href{http://dx.doi.org/10.1103/PhysRevC.76.065209}{\emph{Phys. Rev.} {\bf
  C76} (2007) 065209}, [\href{https://arxiv.org/abs/0708.2297}{{\tt
  0708.2297}}].

\bibitem{Burkardt:2007rv}
M.~Burkardt, \emph{{Spin-orbit correlations and single-spin asymmetries}},  in
  \emph{{Workshop on Exclusive Reactions at High Momentum Transfer Newport
  News, Virginia, May 21-24, 2007}}, 2007.
\newblock \href{https://arxiv.org/abs/0709.2966}{{\tt 0709.2966}}.

\bibitem{Burkardt:2009rf}
M.~Burkardt, \emph{{The $g_{2}$ Structure Function}},
  \href{http://dx.doi.org/10.1063/1.3203298}{\emph{AIP Conf.Proc.} {\bf 1155}
  (2009) 26--34}, [\href{https://arxiv.org/abs/0905.4079}{{\tt 0905.4079}}].

\bibitem{Bacchetta:1999kz}
A.~Bacchetta, M.~Boglione, A.~Henneman and P.~J. Mulders, \emph{{Bounds on
  Transverse Momentum Dependent Distribution and Fragmentation Functions}},
  \href{http://dx.doi.org/10.1103/PhysRevLett.85.712}{\emph{Phys. Rev. Lett.}
  {\bf 85} (2000) 712--715}, [\href{https://arxiv.org/abs/hep-ph/9912490}{{\tt
  hep-ph/9912490}}].

\bibitem{Wandzura:1977qf}
S.~Wandzura and F.~Wilczek, \emph{{Sum rules for spin-dependent
  electroproduction: Test of relativistic constituent quarks}},
  \href{http://dx.doi.org/10.1016/0370-2693(77)90700-6}{\emph{Phys. Lett.} {\bf
  B72} (1977) 195}.

\bibitem{Jaffe:1991ra}
R.~Jaffe and X.~Ji, \emph{{Chiral-odd parton distributions and Drell--Yan
  processes}},
  \href{http://dx.doi.org/10.1016/0550-3213(92)90110-W}{\emph{Nucl. Phys.} {\bf
  B375} (1992) 527--560}.

\bibitem{Jaffe:1989xx}
R.~L. Jaffe, \emph{{$g_{2}$-The Nucleon's Other Spin-Dependent Structure
  Function}}, {\emph{Comments Nucl. Part. Phys.} {\bf 19} (1990) 239--257}.

\bibitem{Balla:1997hf}
J.~Balla, M.~V. Polyakov and C.~Weiss, \emph{{Nucleon matrix elements of
  higher-twist operators from the instanton vacuum}},
  \href{http://dx.doi.org/10.1016/S0550-3213(98)00638-5}{\emph{Nucl. Phys.}
  {\bf B510} (1998) 327--364},
  [\href{https://arxiv.org/abs/hep-ph/9707515}{{\tt hep-ph/9707515}}].

\bibitem{Dressler:1999hc}
B.~Dressler and M.~V. Polyakov, \emph{{Twist-three contribution to $h_{L}$ in
  the instanton vacuum}},
  \href{http://dx.doi.org/10.1103/PhysRevD.61.097501}{\emph{Phys. Rev.} {\bf
  D61} (2000) 097501}, [\href{https://arxiv.org/abs/hep-ph/9912376}{{\tt
  hep-ph/9912376}}].

\bibitem{Gockeler:2000ja}
M.~G{\"o}ckeler, R.~Horsley, W.~K{\"u}rzinger, H.~Oelrich, D.~Pleiter et~al.,
  \emph{{Lattice calculation of the nucleon's spin-dependent structure function
  $g_{2}$ reexamined}},
  \href{http://dx.doi.org/10.1103/PhysRevD.63.074506}{\emph{Phys. Rev.} {\bf
  D63} (2001) 074506}, [\href{https://arxiv.org/abs/hep-lat/0011091}{{\tt
  hep-lat/0011091}}].

\bibitem{Gockeler:2005vw}
M.~G{\"o}ckeler, R.~Horsley, D.~Pleiter, P.~E. Rakow, A.~Sch{\"a}fer et~al.,
  \emph{{Investigation of the second moment of the nucleon's $g_{1}$ and
  $g_{2}$ structure functions in two-flavor lattice QCD}},
  \href{http://dx.doi.org/10.1103/PhysRevD.72.054507}{\emph{Phys. Rev.} {\bf
  D72} (2005) 054507}, [\href{https://arxiv.org/abs/hep-lat/0506017}{{\tt
  hep-lat/0506017}}].

\bibitem{Abe:1998wq}
{\scshape E143} collaboration, K.~Abe et~al., \emph{{Measurements of the proton
  and deuteron spin structure functions $g_{1}$ and $g_{2}$}},
  \href{http://dx.doi.org/10.1103/PhysRevD.58.112003}{\emph{Phys. Rev.} {\bf
  D58} (1998) 112003}, [\href{https://arxiv.org/abs/hep-ph/9802357}{{\tt
  hep-ph/9802357}}].

\bibitem{Anthony:2002hy}
{\scshape E155} collaboration, P.~L. Anthony et~al., \emph{{Precision
  measurement of the proton and deuteron spin structure functions $g_{2}$ and
  asymmetries $A_{2}$}},
  \href{http://dx.doi.org/10.1016/S0370-2693(02)03015-0}{\emph{Phys. Lett.}
  {\bf B553} (2003) 18--24}, [\href{https://arxiv.org/abs/hep-ex/0204028}{{\tt
  hep-ex/0204028}}].

\bibitem{Airapetian:2011wu}
{\scshape HERMES} collaboration, A.~Airapetian et~al., \emph{{Measurement of
  the virtual-photon asymmetry $A_2$ and the spin-structure function $g_2$ of
  the proton}},
  \href{http://dx.doi.org/10.1140/epjc/s10052-012-1921-5}{\emph{Eur. Phys. J.}
  {\bf C72} (2012) 1921}, [\href{https://arxiv.org/abs/1112.5584}{{\tt
  1112.5584}}].

\bibitem{Kotzinian:1995cz}
A.~M. Kotzinian and P.~J. Mulders, \emph{{Longitudinal quark polarization in
  transversely polarized nucleons}},
  \href{http://dx.doi.org/10.1103/PhysRevD.54.1229}{\emph{Phys. Rev.} {\bf D54}
  (1996) 1229--1232}, [\href{https://arxiv.org/abs/hep-ph/9511420}{{\tt
  hep-ph/9511420}}].

\bibitem{Kotzinian:1997wt}
A.~M. Kotzinian and P.~J. Mulders, \emph{{Probing transverse quark polarization
  via azimuthal asymmetries in leptoproduction}},
  \href{http://dx.doi.org/10.1016/S0370-2693(97)00708-9}{\emph{Phys. Lett.}
  {\bf B406} (1997) 373--380},
  [\href{https://arxiv.org/abs/hep-ph/9701330}{{\tt hep-ph/9701330}}].

\bibitem{Kotzinian:2006dw}
A.~Kotzinian, B.~Parsamyan and A.~Prokudin, \emph{{Predictions for double spin
  asymmetry $A_{LT}$ in semiinclusive DIS}},
  \href{http://dx.doi.org/10.1103/PhysRevD.73.114017}{\emph{Phys. Rev.} {\bf
  D73} (2006) 114017}, [\href{https://arxiv.org/abs/hep-ph/0603194}{{\tt
  hep-ph/0603194}}].

\bibitem{Avakian:2007mv}
H.~Avakian et~al., \emph{{Are there approximate relations among transverse
  momentum dependent distribution functions?}},
  \href{http://dx.doi.org/10.1103/PhysRevD.77.014023}{\emph{Phys. Rev.} {\bf
  D77} (2008) 014023}, [\href{https://arxiv.org/abs/0709.3253}{{\tt
  0709.3253}}].

\bibitem{Metz:2008ib}
A.~Metz, P.~Schweitzer and T.~Teckentrup, \emph{{Lorentz invariance relations
  between parton distributions and the Wandzura--Wilczek approximation}},
  \href{http://dx.doi.org/10.1016/j.physletb.2009.08.052}{\emph{Phys. Lett.}
  {\bf B680} (2009) 141--147}, [\href{https://arxiv.org/abs/0810.5212}{{\tt
  0810.5212}}].

\bibitem{Teckentrup:2009tk}
T.~Teckentrup, A.~Metz and P.~Schweitzer, \emph{{Lorentz invariance relations
  and Wandzura--Wilczek approximation}},
  \href{http://dx.doi.org/10.1142/S0217732309001169}{\emph{Mod. Phys. Lett.}
  {\bf A24} (2009) 2950--2959}, [\href{https://arxiv.org/abs/0910.2567}{{\tt
  0910.2567}}].

\bibitem{Tangerman:1994bb}
R.~Tangerman and P.~Mulders, \emph{{Polarized twist-three distributions $g_{T}$
  and $h_{L}$ and the role of intrinsic transverse momentum}},
  \href{https://arxiv.org/abs/hep-ph/9408305}{{\tt hep-ph/9408305}}.

\bibitem{Avakian:2015vha}
H.~Avakian, H.~Matevosyan, B.~Pasquini and P.~Schweitzer, \emph{{Studying the
  information content of TMDs using Monte Carlo generators}},
  \href{http://dx.doi.org/10.1088/0954-3899/42/3/034015}{\emph{J. Phys.} {\bf
  G42} (2015) 034015}.

\bibitem{Metz:2004je}
A.~Metz and M.~Schlegel, \emph{{Twist-3 single-spin asymmetries in
  semi-inclusive deep-inelastic scattering}},
  \href{http://dx.doi.org/10.1140/epja/i2004-10050-8}{\emph{Eur. Phys. J.} {\bf
  A22} (2004) 489--494}, [\href{https://arxiv.org/abs/hep-ph/0403182}{{\tt
  hep-ph/0403182}}].

\bibitem{Gamberg:2006ru}
L.~P. Gamberg, D.~S. Hwang, A.~Metz and M.~Schlegel, \emph{{Light-cone
  divergence in twist-3 correlation functions}},
  \href{http://dx.doi.org/10.1016/j.physletb.2006.07.005}{\emph{Phys. Lett.}
  {\bf B639} (2006) 508--512},
  [\href{https://arxiv.org/abs/hep-ph/0604022}{{\tt hep-ph/0604022}}].
...
J.~P. Ralston and D.~E. Soper, \emph{{Production of Dimuons from High-Energy
  Polarized Proton Proton Collisions}},
  \href{http://dx.doi.org/10.1016/0550-3213(79)90082-8}{\emph{Nucl. Phys.} {\bf
  B152} (1979) 109}.

\bibitem{Collins:1981uk}
J.~C. Collins and D.~E. Soper, \emph{{Back-To-Back Jets in QCD}},
  \href{http://dx.doi.org/10.1016/0550-3213(81)90339-4}{\emph{Nucl. Phys.} {\bf
  B193} (1981) 381}.

\bibitem{Ji:2004wu}
X.~Ji, J.-P. Ma and F.~Yuan, \emph{{QCD factorization for semi-inclusive
  deep-inelastic scattering at low transverse momentum}},
  \href{http://dx.doi.org/10.1103/PhysRevD.71.034005}{\emph{Phys. Rev.} {\bf
  D71} (2005) 034005}, [\href{https://arxiv.org/abs/hep-ph/0404183}{{\tt
  hep-ph/0404183}}].

\bibitem{Ji:2004xq}
X.~Ji, J.-P. Ma and F.~Yuan, \emph{{QCD factorization for spin-dependent cross
  sections in DIS and Drell-Yan processes at low transverse momentum}},
  \href{http://dx.doi.org/10.1016/j.physletb.2004.07.026}{\emph{Phys. Lett.}
  {\bf B597} (2004) 299--308},
  [\href{https://arxiv.org/abs/hep-ph/0405085}{{\tt hep-ph/0405085}}].

\bibitem{Collins:2011zzd}
J.~Collins, \emph{{Foundations of perturbative QCD}}, {\emph{Camb. Monogr.
  Part. Phys. Nucl. Phys. Cosmol.} {\bf 32} (2011) 1--624}.

\bibitem{Echevarria:2012js}
M.~G. Echevarr\'ia, A.~Idilbi and I.~Scimemi, \emph{{Soft and collinear
  factorization and transverse momentum dependent parton distribution
  functions}},
  \href{http://dx.doi.org/10.1016/j.physletb.2013.09.003}{\emph{Phys. Lett.}
  {\bf B726} (2013) 795--801}, [\href{https://arxiv.org/abs/1211.1947}{{\tt
  1211.1947}}].

\bibitem{Aybat:2011zv}
S.~M. Aybat and T.~C. Rogers, \emph{{TMD Parton Distribution and Fragmentation
  Functions with QCD Evolution}},
  \href{http://dx.doi.org/10.1103/PhysRevD.83.114042}{\emph{Phys. Rev.} {\bf
  D83} (2011) 114042}, [\href{https://arxiv.org/abs/1101.5057}{{\tt
  1101.5057}}].

\bibitem{Aybat:2011ge}
S.~M. Aybat, J.~C. Collins, J.-W. Qiu and T.~C. Rogers, \emph{{The QCD
  Evolution of the Sivers Function}},
  \href{http://dx.doi.org/10.1103/PhysRevD.85.034043}{\emph{Phys. Rev.} {\bf
  D85} (2012) 034043}, [\href{https://arxiv.org/abs/1110.6428}{{\tt
  1110.6428}}].

\bibitem{Echevarria:2014xaa}
M.~G. Echevarria, A.~Idilbi, Z.-B. Kang and I.~Vitev, \emph{{QCD Evolution of
  the Sivers Asymmetry}},
  \href{http://dx.doi.org/10.1103/PhysRevD.89.074013}{\emph{Phys. Rev.} {\bf
  D89} (2014) 074013}, [\href{https://arxiv.org/abs/1401.5078}{{\tt
  1401.5078}}].

\bibitem{Collins:2014jpa}
J.~Collins and T.~Rogers, \emph{{Understanding the large-distance behavior of
  transverse-momentum-dependent parton densities and the Collins-Soper
  evolution kernel}},
  \href{http://dx.doi.org/10.1103/PhysRevD.91.074020}{\emph{Phys. Rev.} {\bf
  D91} (2015) 074020}, [\href{https://arxiv.org/abs/1412.3820}{{\tt
  1412.3820}}].

\bibitem{Ma:2013aca}
J.~P. Ma and G.~P. Zhang, \emph{{QCD corrections of all structure functions in
  transverse momentum dependent factorization for Drell--Yan processes}},
  \href{http://dx.doi.org/10.1007/JHEP02(2014)100}{\emph{JHEP} {\bf 02} (2014)
  100}, [\href{https://arxiv.org/abs/1308.2044}{{\tt 1308.2044}}].

\bibitem{Aybat:2011ta}
S.~M. Aybat, A.~Prokudin and T.~C. Rogers, \emph{{Calculation of TMD Evolution
  for Transverse Single Spin Asymmetry Measurements}},
  \href{http://dx.doi.org/10.1103/PhysRevLett.108.242003}{\emph{Phys. Rev.
  Lett.} {\bf 108} (2012) 242003}, [\href{https://arxiv.org/abs/1112.4423}{{\tt
  1112.4423}}].

\bibitem{Kang:2015msa}
Z.-B. Kang, A.~Prokudin, P.~Sun and F.~Yuan, \emph{{Extraction of quark
  transversity distribution and Collins fragmentation functions with QCD
  evolution}}, \href{http://dx.doi.org/10.1103/PhysRevD.93.014009}{\emph{Phys.
  Rev.} {\bf D93} (2016) 014009}, [\href{https://arxiv.org/abs/1505.05589}{{\tt
  1505.05589}}].

\bibitem{Gutierrez-Reyes:2017glx}
D.~Gutiérrez-Reyes, I.~Scimemi and A.~A. Vladimirov, \emph{{Twist-2 matching of
  transverse momentum dependent distributions}},
  \href{http://dx.doi.org/10.1016/j.physletb.2017.03.031}{\emph{Phys. Lett.}
  {\bf B769} (2017) 84--89}, [\href{https://arxiv.org/abs/1702.06558}{{\tt
  1702.06558}}].

\bibitem{Gutierrez-Reyes:2018qez}
D.~Gutierrez-Reyes, I.~Scimemi, W.~J. Waalewijn and L.~Zoppi,
  \emph{{Transverse-Momentum-Dependent Distributions with Jets}},
  \href{http://dx.doi.org/10.1103/PhysRevLett.121.162001}{\emph{Phys. Rev.
  Lett.} {\bf 121} (2018) 162001},
  [\href{https://arxiv.org/abs/1807.07573}{{\tt 1807.07573}}].

\bibitem{Scimemi:2018mmi}
I.~Scimemi and A.~Vladimirov, \emph{{Matching of transverse momentum dependent
  distributions at twist-3}},
  \href{http://dx.doi.org/10.1140/epjc/s10052-018-6263-5}{\emph{Eur. Phys. J.}
  {\bf C78} (2018) 802}, [\href{https://arxiv.org/abs/1804.08148}{{\tt
  1804.08148}}].

\bibitem{Chen:2016hgw}
A.~P. Chen and J.~P. Ma, \emph{{Light-cone singularities and
  transverse-momentum-dependent factorization at twist-3}},
  \href{http://dx.doi.org/10.1016/j.physletb.2017.03.015}{\emph{Phys. Lett.}
  {\bf B768} (2017) 380--386}, [\href{https://arxiv.org/abs/1610.08634}{{\tt
  1610.08634}}].

\bibitem{Efremov:2002qh}
A.~V. Efremov and P.~Schweitzer, \emph{{The chirally-odd twist-3 distribution
  $e^{a}(x)$}},
  \href{http://dx.doi.org/10.1088/1126-6708/2003/08/006}{\emph{JHEP} {\bf 08}
  (2003) 006}, [\href{https://arxiv.org/abs/hep-ph/0212044}{{\tt
  hep-ph/0212044}}].

\bibitem{Jaffe:1996zw}
R.~L. Jaffe, \emph{{Spin, twist and hadron structure in deep inelastic
  processes}},  in \emph{{The spin structure of the nucleon. Proceedings,
  International School of Nucleon Structure, 1st Course, Erice, Italy, August
  3-10, 1995}}, pp.~42--129, 1996.
\newblock \href{https://arxiv.org/abs/hep-ph/9602236}{{\tt hep-ph/9602236}}.

\bibitem{Kanazawa:2015ajw}
K.~Kanazawa, Y.~Koike, A.~Metz, D.~Pitonyak and M.~Schlegel, \emph{{Operator
  constraints for twist-3 functions and Lorentz invariance properties of
  twist-3 observables}},
  \href{http://dx.doi.org/10.1103/PhysRevD.93.054024}{\emph{Phys. Rev.} {\bf
  D93} (2016) 054024}, [\href{https://arxiv.org/abs/1512.07233}{{\tt
  1512.07233}}].

\bibitem{Shuryak:1981ff}
E.~V. Shuryak, \emph{{The role of instantons in quantum chromodynamics: (I).
  Physical vacuum}},
  \href{http://dx.doi.org/10.1016/0550-3213(82)90478-3}{\emph{Nucl. Phys.} {\bf
  B203} (1982) 93}.

\bibitem{Diakonov:1983hh}
D.~Diakonov and V.~Y. Petrov, \emph{{Instanton-based vacuum from Feynman
  variational principle}},
  \href{http://dx.doi.org/10.1016/0550-3213(84)90432-2}{\emph{Nucl. Phys.} {\bf
  B245} (1984) 259}.

\bibitem{Diakonov:1995qy}
D.~Diakonov, M.~V. Polyakov and C.~Weiss, \emph{{Hadronic matrix elements of
  gluon operators in the instanton vacuum}},
  \href{http://dx.doi.org/10.1016/0550-3213(95)00675-3}{\emph{Nucl. Phys.} {\bf
  B461} (1996) 539--580}, [\href{https://arxiv.org/abs/hep-ph/9510232}{{\tt
  hep-ph/9510232}}].

\bibitem{Adams:1994id}
{\scshape Spin Muon} collaboration, D.~Adams et~al., \emph{{Spin asymmetry in
  muon-proton deep inelastic scattering on a transversely polarized target}},
  \href{http://dx.doi.org/10.1016/0370-2693(94)00968-6}{\emph{Phys. Lett.} {\bf
  B336} (1994) 125--130}, [\href{https://arxiv.org/abs/hep-ex/9408001}{{\tt
  hep-ex/9408001}}].

\bibitem{Accardi:2009au}
A.~Accardi, A.~Bacchetta, W.~Melnitchouk and M.~Schlegel, \emph{{What can break
  the Wandzura--Wilczek relation?}},
  \href{http://dx.doi.org/10.1088/1126-6708/2009/11/093}{\emph{JHEP} {\bf 11}
  (2009) 093}, [\href{https://arxiv.org/abs/0907.2942}{{\tt 0907.2942}}].

\bibitem{Gluck:1998xa}
M.~Gl{\"u}ck, E.~Reya and A.~Vogt, \emph{{Dynamical parton distributions
  revisited}}, \href{http://dx.doi.org/10.1007/s100520050289}{\emph{Eur. Phys.
  J.} {\bf C5} (1998) 461--470},
  [\href{https://arxiv.org/abs/hep-ph/9806404}{{\tt hep-ph/9806404}}].

\bibitem{Efremov:2006qm}
A.~V. Efremov, K.~Goeke and P.~Schweitzer, \emph{{Collins effect in
  semiinclusive deeply inelastic scattering and in
  electron-positron-annihilation}},
  \href{http://dx.doi.org/10.1103/PhysRevD.73.094025}{\emph{Phys. Rev.} {\bf
  D73} (2006) 094025}, [\href{https://arxiv.org/abs/hep-ph/0603054}{{\tt
  hep-ph/0603054}}].

\bibitem{Anselmino:2007fs}
M.~Anselmino et~al., \emph{{Transversity and Collins functions from SIDIS and
  $e^{+} e^{-}$ data}},
  \href{http://dx.doi.org/10.1103/PhysRevD.75.054032}{\emph{Phys. Rev.} {\bf
  D75} (2007) 054032}, [\href{https://arxiv.org/abs/hep-ph/0701006}{{\tt
  hep-ph/0701006}}].

\bibitem{Anselmino:2008jk}
M.~Anselmino et~al., \emph{{Update on transversity and Collins functions from
  SIDIS and $e^{+} e^{-}$ data}},
  \href{http://dx.doi.org/10.1016/j.nuclphysbps.2009.03.117}{\emph{Nucl. Phys.
  Proc. Suppl.} {\bf 191} (2009) 98--107},
  [\href{https://arxiv.org/abs/0812.4366}{{\tt 0812.4366}}].

\bibitem{Koike:2008du}
Y.~Koike, K.~Tanaka and S.~Yoshida, \emph{{Drell--Yan double-spin asymmetry
  $A_{LT}$ in polarized $p\bar{p}$ collisions: Wandzura--Wilczek
  contribution}},
  \href{http://dx.doi.org/10.1016/j.physletb.2008.08.049}{\emph{Phys. Lett.}
  {\bf B668} (2008) 286--292}, [\href{https://arxiv.org/abs/0805.2289}{{\tt
  0805.2289}}].

\bibitem{Hagler:2009mb}
P.~H{\"a}gler, B.~U. Musch, J.~W. Negele and A.~Sch{\"a}fer, \emph{{Intrinsic
  quark transverse momentum in the nucleon from lattice QCD}},
  \href{http://dx.doi.org/10.1209/0295-5075/88/61001}{\emph{Europhys. Lett.}
  {\bf 88} (2009) 61001}, [\href{https://arxiv.org/abs/0908.1283}{{\tt
  0908.1283}}].

\bibitem{Musch:2010ka}
B.~U. Musch, P.~H{\"a}gler, J.~W. Negele and A.~Sch{\"a}fer, \emph{{Exploring
  quark transverse momentum distributions with lattice QCD}},
  \href{http://dx.doi.org/10.1103/PhysRevD.83.094507}{\emph{Phys. Rev.} {\bf
  D83} (2011) 094507}, [\href{https://arxiv.org/abs/1011.1213}{{\tt
  1011.1213}}].

\bibitem{Alexandrou:2017dzj}
C.~Alexandrou, S.~Bacchio, K.~Cichy, M.~Constantinou, K.~Hadjiyiannakou,
  K.~Jansen et~al., \emph{{Computation of parton distributions from the
  quasi-PDF approach at the physical point}},
  \href{http://dx.doi.org/10.1051/epjconf/201817514008}{\emph{EPJ Web Conf.}
  {\bf 175} (2018) 14008}, [\href{https://arxiv.org/abs/1710.06408}{{\tt
  1710.06408}}].
...
T.~Ishikawa, Y.-Q. Ma, J.-W. Qiu and S.~Yoshida, \emph{{Renormalizability of
  ...
  \href{http://dx.doi.org/10.1103/PhysRevD.96.094019}{\emph{Phys. Rev.} {\bf
  D96} (2017) 094019}, [\href{https://arxiv.org/abs/1707.03107}{{\tt
  1707.03107}}].

\bibitem{Engelhardt:2015xja}
M.~Engelhardt, P.~H{\"a}gler, B.~Musch, J.~Negele and A.~Sch{\"a}fer,
  \emph{{Lattice QCD study of the Boer-Mulders effect in a pion}},
  \href{http://dx.doi.org/10.1103/PhysRevD.93.054501}{\emph{Phys. Rev.} {\bf
  D93} (2016) 054501}, [\href{https://arxiv.org/abs/1506.07826}{{\tt
  1506.07826}}].

\bibitem{Ji:2014hxa}
X.~Ji, P.~Sun, X.~Xiong and F.~Yuan, \emph{{Soft factor subtraction and
  transverse momentum dependent parton distributions on the lattice}},
  \href{http://dx.doi.org/10.1103/PhysRevD.91.074009}{\emph{Phys. Rev.} {\bf
  D91} (2015) 074009}, [\href{https://arxiv.org/abs/1405.7640}{{\tt
  1405.7640}}].

\bibitem{Musch:2011er}
B.~U. Musch, P.~H{\"a}gler, M.~Engelhardt, J.~W. Negele and A.~Sch{\"a}fer,
  \emph{{Sivers and Boer-Mulders observables from lattice QCD}},
  \href{http://dx.doi.org/10.1103/PhysRevD.85.094510}{\emph{Phys. Rev.} {\bf
  D85} (2012) 094510}, [\href{https://arxiv.org/abs/1111.4249}{{\tt
  1111.4249}}].
...
X.~Ji, J.-H. Zhang and Y.~Zhao, \emph{{Renormalization in Large Momentum
  ...
  Lett.} {\bf 120} (2018) 112001},
  [\href{https://arxiv.org/abs/1706.08962}{{\tt 1706.08962}}].

\bibitem{Yoon:2017qzo}
B.~Yoon, M.~Engelhardt, R.~Gupta, T.~Bhattacharya, J.~R. Green, B.~U. Musch
  et~al., \emph{{Nucleon transverse-momentum-dependent parton distributions in
  lattice QCD: Renormalization patterns and discretization effects}},
  \href{http://dx.doi.org/10.1103/PhysRevD.96.094508}{\emph{Phys. Rev.} {\bf
  D96} (2017) 094508}, [\href{https://arxiv.org/abs/1706.03406}{{\tt
  1706.03406}}].
...
J.~Green, K.~Jansen and F.~Steffens, \emph{{Nonperturbative Renormalization of
  ...
  \href{http://dx.doi.org/10.1103/PhysRevLett.121.022004}{\emph{Phys. Rev.
  Lett.} {\bf 121} (2018) 022004},
  [\href{https://arxiv.org/abs/1707.07152}{{\tt 1707.07152}}].

\bibitem{Zhang:2017bzy}
J.-H. Zhang, J.-W. Chen, X.~Ji, L.~Jin and H.-W. Lin, \emph{{Pion distribution
  amplitude from lattice QCD}},
  \href{http://dx.doi.org/10.1103/PhysRevD.95.094514}{\emph{Phys. Rev.} {\bf
  D95} (2017) 094514}, [\href{https://arxiv.org/abs/1702.00008}{{\tt
  1702.00008}}].

\bibitem{Hagler:2003is}
{\scshape LHPC and SESAM} collaboration, LHPC, P.~H{\"a}gler, J.~W. Negele,
  D.~B. Renner, W.~Schroers, T.~Lippert et~al., \emph{{Transverse structure of
  nucleon parton distributions from lattice QCD}},
  \href{http://dx.doi.org/10.1103/PhysRevLett.93.112001}{\emph{Phys. Rev.
  Lett.} {\bf 93} (2004) 112001},
  [\href{https://arxiv.org/abs/hep-lat/0312014}{{\tt hep-lat/0312014}}].

\bibitem{Hagler:2007xi}
{\scshape LHPC} collaboration, P.~H{\"a}gler, W.~Schroers, J.~Bratt, J.~W.
  Negele, A.~V. Pochinsky, R.~G. Edwards et~al., \emph{{Nucleon generalized
  parton distributions from full lattice QCD}},
  \href{http://dx.doi.org/10.1103/PhysRevD.77.094502}{\emph{Phys. Rev.} {\bf
  D77} (2008) 094502}, [\href{https://arxiv.org/abs/0705.4295}{{\tt
  0705.4295}}].

\bibitem{Gockeler:2005cj}
{\scshape QCDSF and UKQCD} collaboration, M.~G{\"o}ckeler, P.~H{\"a}gler,
  R.~Horsley, D.~Pleiter, P.~E.~L. Rakow, A.~Sch{\"a}fer et~al., \emph{{Quark
  helicity flip generalized parton distributions from two-flavor lattice QCD}},
  \href{http://dx.doi.org/10.1016/j.physletb.2005.09.002}{\emph{Phys. Lett.}
  {\bf B627} (2005) 113--123},
  [\href{https://arxiv.org/abs/hep-lat/0507001}{{\tt hep-lat/0507001}}].

\bibitem{Burkardt:2001iy}
M.~Burkardt and Y.~Koike, \emph{{Violation of sum rules for twist-3 parton
  distributions in QCD}},
  \href{http://dx.doi.org/10.1016/S0550-3213(02)00263-8}{\emph{Nucl. Phys.}
  {\bf B632} (2002) 311--329},
  [\href{https://arxiv.org/abs/hep-ph/0111343}{{\tt hep-ph/0111343}}].

\bibitem{Bass:2003vp}
S.~D. Bass, \emph{{Fixed poles, polarized glue and nucleon spin structure}},
  {\emph{Acta Phys. Polon.} {\bf B34} (2003) 5893--5926},
  [\href{https://arxiv.org/abs/hep-ph/0311174}{{\tt hep-ph/0311174}}].

\bibitem{Stratmann:1993aw}
M.~Stratmann, \emph{{Bag model predictions for polarized structure functions
  and their $Q^{2}$-evolutions}},
  \href{http://dx.doi.org/10.1007/BF01558408}{\emph{Z. Phys.} {\bf C60} (1993)
  763--772}.

\bibitem{Signal:1996ct}
A.~Signal, \emph{{Calculations of higher twist distribution functions in the
  MIT bag model}},
  \href{http://dx.doi.org/10.1016/S0550-3213(97)00231-9}{\emph{Nucl. Phys.}
  {\bf B497} (1997) 415--434},
  [\href{https://arxiv.org/abs/hep-ph/9610480}{{\tt hep-ph/9610480}}].

\bibitem{Avakian:2010br}
H.~Avakian, A.~Efremov, P.~Schweitzer and F.~Yuan, \emph{{The transverse
  momentum dependent distribution functions in the bag model}},
  \href{http://dx.doi.org/10.1103/PhysRevD.81.074035}{\emph{Phys. Rev.} {\bf
  D81} (2010) 074035}, [\href{https://arxiv.org/abs/1001.5467}{{\tt
  1001.5467}}].

\bibitem{Jakob:1997wg}
R.~Jakob, P.~Mulders and J.~Rodrigues, \emph{{Modeling quark distribution and
  fragmentation functions}},
  \href{http://dx.doi.org/10.1016/S0375-9474(97)00588-5}{\emph{Nucl. Phys.}
  {\bf A626} (1997) 937--965},
  [\href{https://arxiv.org/abs/hep-ph/9704335}{{\tt hep-ph/9704335}}].

\bibitem{Wakamatsu:2000ex}
M.~Wakamatsu, \emph{{Polarized structure functions $g_{2}(x)$ in the chiral
  quark soliton model}},
  \href{http://dx.doi.org/10.1016/S0370-2693(00)00790-5}{\emph{Phys. Lett.}
  {\bf B487} (2000) 118--124},
  [\href{https://arxiv.org/abs/hep-ph/0006212}{{\tt hep-ph/0006212}}].

\bibitem{Pasquini:2008ax}
B.~Pasquini, S.~Cazzaniga and S.~Boffi, \emph{{Transverse momentum dependent
  parton distributions in a light-cone quark model}},
  \href{http://dx.doi.org/10.1103/PhysRevD.78.034025}{\emph{Phys. Rev.} {\bf
  D78} (2008) 034025}, [\href{https://arxiv.org/abs/0806.2298}{{\tt
  0806.2298}}].

\bibitem{Lorce:2011dv}
C.~Lorc\'e, B.~Pasquini and M.~Vanderhaeghen, \emph{{Unified framework for
  generalized and transverse-momentum dependent parton distributions within a
  3Q light-cone picture of the nucleon}},
  \href{http://dx.doi.org/10.1007/JHEP05(2011)041}{\emph{JHEP} {\bf 1105}
  (2011) 041}, [\href{https://arxiv.org/abs/1102.4704}{{\tt 1102.4704}}].

\bibitem{Kundu:2001pk}
R.~Kundu and A.~Metz, \emph{{Higher twist and transverse momentum dependent
  parton distributions: A Light front Hamiltonian approach}},
  \href{http://dx.doi.org/10.1103/PhysRevD.65.014009}{\emph{Phys. Rev.} {\bf
  D65} (2002) 014009}, [\href{https://arxiv.org/abs/hep-ph/0107073}{{\tt
  hep-ph/0107073}}].

\bibitem{Schlegel:2004rg}
M.~Schlegel and A.~Metz, \emph{{On the validity of Lorentz invariance relations
  between parton distributions}},  in \emph{{Proceedings, 10th Advanced
  Research Workshop on High-Energy Spin Physics, Dubna, Russia, September
  16-20, 2003}}, pp.~169--173, 2004.
\newblock \href{https://arxiv.org/abs/hep-ph/0406289}{{\tt hep-ph/0406289}}.

\bibitem{Goeke:2003az}
K.~Goeke, A.~Metz, P.~Pobylitsa and M.~Polyakov, \emph{{Lorentz invariance
  relations among parton distributions revisited}},
  \href{http://dx.doi.org/10.1016/S0370-2693(03)00870-0}{\emph{Phys. Lett.}
  {\bf B567} (2003) 27--30}, [\href{https://arxiv.org/abs/hep-ph/0302028}{{\tt
  hep-ph/0302028}}].

\bibitem{Lorce:2014hxa}
C.~Lorc\'e, B.~Pasquini and P.~Schweitzer, \emph{{Unpolarized transverse
  momentum dependent parton distribution functions beyond leading twist in
  quark models}}, \href{http://dx.doi.org/10.1007/JHEP01(2015)103}{\emph{JHEP}
  {\bf 01} (2015) 103}, [\href{https://arxiv.org/abs/1411.2550}{{\tt
  1411.2550}}].

\bibitem{Lorce:2016ugb}
C.~Lorc\'e, B.~Pasquini and P.~Schweitzer, \emph{{Transverse pion structure
  beyond leading twist in constituent models}},
  \href{http://dx.doi.org/10.1140/epjc/s10052-016-4257-8}{\emph{Eur. Phys. J.}
  {\bf C76} (2016) 415}, [\href{https://arxiv.org/abs/1605.00815}{{\tt
  1605.00815}}].

\bibitem{Zavada:1996kp}
P.~Zavada, \emph{{The Structure functions and parton momenta distribution in
  the hadron rest system}},
  \href{http://dx.doi.org/10.1103/PhysRevD.55.4290}{\emph{Phys. Rev.} {\bf D55}
  (1997) 4290--4299}, [\href{https://arxiv.org/abs/hep-ph/9609372}{{\tt
  hep-ph/9609372}}].

\bibitem{Efremov:2010mt}
A.~V. Efremov, P.~Schweitzer, O.~V. Teryaev and P.~Zavada, \emph{{The relation
  between TMDs and PDFs in the covariant parton model approach}},
  \href{http://dx.doi.org/10.1103/PhysRevD.83.054025}{\emph{Phys. Rev.} {\bf
  D83} (2011) 054025}, [\href{https://arxiv.org/abs/1012.5296}{{\tt
  1012.5296}}].

\bibitem{Efremov:2009ze}
A.~V. Efremov, P.~Schweitzer, O.~V. Teryaev and P.~Zavada, \emph{{Transverse
  momentum dependent distribution functions in a covariant parton model
  approach with quark orbital motion}},
  \href{http://dx.doi.org/10.1103/PhysRevD.80.014021}{\emph{Phys. Rev.} {\bf
  D80} (2009) 014021}, [\href{https://arxiv.org/abs/0903.3490}{{\tt
  0903.3490}}].

\bibitem{Schweitzer:2003uy}
P.~Schweitzer, \emph{{Chirally-odd twist-3 distribution function $e^{a}(x)$ in
  the chiral quark-soliton model}},
  \href{http://dx.doi.org/10.1103/PhysRevD.67.114010}{\emph{Phys. Rev.} {\bf
  D67} (2003) 114010}, [\href{https://arxiv.org/abs/hep-ph/0303011}{{\tt
  hep-ph/0303011}}].

\bibitem{Ohnishi:2003mf}
Y.~Ohnishi and M.~Wakamatsu, \emph{{$\pi N$ sigma term and chira-odd twist-3
  distribution function $e(x)$ of the nucleon in the chiral quark soliton
  model}}, \href{http://dx.doi.org/10.1103/PhysRevD.69.114002}{\emph{Phys.
  Rev.} {\bf D69} (2004) 114002},
  [\href{https://arxiv.org/abs/hep-ph/0312044}{{\tt hep-ph/0312044}}].

\bibitem{Cebulla:2007ej}
C.~Cebulla, J.~Ossmann, P.~Schweitzer and D.~Urbano, \emph{{The Twist-3 Parton
  Distribution Function $e^{a}(x)$ in Large-N$_{c}$ Chiral Theory}},
  {\emph{Acta Phys. Polon.} {\bf B39} (2008) 609--640},
  [\href{https://arxiv.org/abs/0710.3103}{{\tt 0710.3103}}].

\bibitem{Meissner:2007rx}
S.~Meissner, A.~Metz and K.~Goeke, \emph{{Relations between generalized and
  transverse momentum dependent parton distributions}},
  \href{http://dx.doi.org/10.1103/PhysRevD.76.034002}{\emph{Phys. Rev.} {\bf
  D76} (2007) 034002}, [\href{https://arxiv.org/abs/hep-ph/0703176}{{\tt
  hep-ph/0703176}}].

\bibitem{Mukherjee:2009uy}
A.~Mukherjee, \emph{{Twist-three Distribution $e(x)$: Sum Rules and Equation of
  Motion Relations}},
  \href{http://dx.doi.org/10.1016/j.physletb.2010.03.023}{\emph{Phys. Lett.}
  {\bf B687} (2010) 180--183}, [\href{https://arxiv.org/abs/0912.1446}{{\tt
  0912.1446}}].

\bibitem{Harindranath:1997qn}
A.~Harindranath and W.-M. Zhang, \emph{{Examination of Wandzura--Wilczek
  relation for $g_{2} (x,Q^{2})$ in pQCD}},
  \href{http://dx.doi.org/10.1016/S0370-2693(97)00771-5}{\emph{Phys. Lett.}
  {\bf B408} (1997) 347--356},
  [\href{https://arxiv.org/abs/hep-ph/9706419}{{\tt hep-ph/9706419}}].

\bibitem{Boer:2003cm}
D.~Boer, P.~J. Mulders and F.~Pijlman, \emph{{Universality of T-odd effects in
  single spin and azimuthal asymmetries}},
  \href{http://dx.doi.org/10.1016/S0550-3213(03)00527-3}{\emph{Nucl. Phys.}
  {\bf B667} (2003) 201--241},
  [\href{https://arxiv.org/abs/hep-ph/0303034}{{\tt hep-ph/0303034}}].

\bibitem{Ji:2006ub}
X.~Ji, J.-W. Qiu, W.~Vogelsang and F.~Yuan, \emph{{Unified Picture for Single
  Transverse-Spin Asymmetries in Hard-Scattering Processes}},
  \href{http://dx.doi.org/10.1103/PhysRevLett.97.082002}{\emph{Phys. Rev.
  Lett.} {\bf 97} (2006) 082002},
  [\href{https://arxiv.org/abs/hep-ph/0602239}{{\tt hep-ph/0602239}}].
...
\bibitem{Anselmino:2005nn}
M.~Anselmino et~al., \emph{{The role of Cahn and Sivers effects in deep
  inelastic scattering}},
  \href{http://dx.doi.org/10.1103/PhysRevD.71.074006}{\emph{Phys. Rev.} {\bf
  D71} (2005) 074006}, [\href{https://arxiv.org/abs/hep-ph/0501196}{{\tt
  hep-ph/0501196}}].

\bibitem{Collins:2005ie}
J.~C. Collins, A.~V. Efremov, K.~Goeke, S.~Menzel, A.~Metz and P.~Schweitzer,
  \emph{{Sivers effect in semiinclusive deeply inelastic scattering}},
  \href{http://dx.doi.org/10.1103/PhysRevD.73.014021}{\emph{Phys. Rev.} {\bf
  D73} (2006) 014021}, [\href{https://arxiv.org/abs/hep-ph/0509076}{{\tt
  hep-ph/0509076}}].

\bibitem{D'Alesio:2007jt}
U.~D'Alesio and F.~Murgia, \emph{{Azimuthal and single spin asymmetries in hard
  scattering processes}},
  \href{http://dx.doi.org/10.1016/j.ppnp.2008.01.001}{\emph{Prog. Part. Nucl.
  Phys. 61} {\bf 2008} (2008) 394--454},
  [\href{https://arxiv.org/abs/0712.4328}{{\tt 0712.4328}}].

\bibitem{Schweitzer:2010tt}
P.~Schweitzer, T.~Teckentrup and A.~Metz, \emph{{Intrinsic transverse parton
  momenta in deeply inelastic reactions}},
  \href{http://dx.doi.org/10.1103/PhysRevD.81.094019}{\emph{Phys. Rev.} {\bf
  D81} (2010) 094019}, [\href{https://arxiv.org/abs/1003.2190}{{\tt
  1003.2190}}].

\bibitem{Signori:2013mda}
A.~Signori, A.~Bacchetta, M.~Radici and G.~Schnell, \emph{{Investigations into
  the flavor dependence of partonic transverse momentum}},
  \href{http://dx.doi.org/10.1007/JHEP11(2013)194}{\emph{JHEP} {\bf 11} (2013)
  194}, [\href{https://arxiv.org/abs/1309.3507}{{\tt 1309.3507}}].

\bibitem{Anselmino:2013lza}
M.~Anselmino, M.~Boglione, J.~O. Gonzalez~Hernandez, S.~Melis and A.~Prokudin,
  \emph{{Unpolarised transverse momentum dependent distribution and
  fragmentation functions from SIDIS multiplicities}},
  \href{http://dx.doi.org/10.1007/JHEP04(2014)005}{\emph{JHEP} {\bf 04} (2014)
  005}, [\href{https://arxiv.org/abs/1312.6261}{{\tt 1312.6261}}].

\bibitem{Bacchetta:2008xw}
A.~Bacchetta, D.~Boer, M.~Diehl and P.~J. Mulders, \emph{{Matches and
  mismatches in the descriptions of semi-inclusive processes at low and high
  transverse momentum}},
  \href{http://dx.doi.org/10.1088/1126-6708/2008/08/023}{\emph{JHEP} {\bf 08}
  (2008) 023}, [\href{https://arxiv.org/abs/0803.0227}{{\tt 0803.0227}}].

\bibitem{Landry:2002ix}
F.~Landry, R.~Brock, P.~M. Nadolsky and C.~Yuan, \emph{{Tevatron run-1 $Z$
  boson data and Collins-Soper-Sterman resummation formalism}},
  \href{http://dx.doi.org/10.1103/PhysRevD.67.073016}{\emph{Phys. Rev.} {\bf
  D67} (2003) 073016}, [\href{https://arxiv.org/abs/hep-ph/0212159}{{\tt
  hep-ph/0212159}}].

\bibitem{Martin:2009iq}
A.~D. Martin, W.~J. Stirling, R.~S. Thorne and G.~Watt, \emph{{Parton
  distributions for the LHC}},
  \href{http://dx.doi.org/10.1140/epjc/s10052-009-1072-5}{\emph{Eur. Phys. J.}
  {\bf C63} (2009) 189--285}, [\href{https://arxiv.org/abs/0901.0002}{{\tt
  0901.0002}}].

\bibitem{deFlorian:2007aj}
D.~de~Florian, R.~Sassot and M.~Stratmann, \emph{{Global analysis of
  fragmentation functions for pions and kaons and their uncertainties}},
  \href{http://dx.doi.org/10.1103/PhysRevD.75.114010}{\emph{Phys. Rev.} {\bf
  D75} (2007) 114010}, [\href{https://arxiv.org/abs/hep-ph/0703242}{{\tt
  hep-ph/0703242}}].

\bibitem{Schweitzer:2012hh}
P.~Schweitzer, M.~Strikman and C.~Weiss, \emph{{Intrinsic transverse momentum
  and parton correlations from dynamical chiral symmetry breaking}},
  \href{http://dx.doi.org/10.1007/JHEP01(2013)163}{\emph{JHEP} {\bf 01} (2013)
  163}, [\href{https://arxiv.org/abs/1210.1267}{{\tt 1210.1267}}].

\bibitem{Collins:2016hqq}
J.~Collins, L.~Gamberg, A.~Prokudin, T.~C. Rogers, N.~Sato and B.~Wang,
  \emph{{Relating transverse-momentum-dependent and collinear factorization
  theorems in a generalized formalism}},
  \href{http://dx.doi.org/10.1103/PhysRevD.94.034014}{\emph{Phys. Rev.} {\bf
  D94} (2016) 034014}, [\href{https://arxiv.org/abs/1605.00671}{{\tt
  1605.00671}}].

\bibitem{Osipenko:2008aa}
{\scshape CLAS} collaboration, M.~Osipenko et~al., \emph{{Measurement of
  unpolarized semi-inclusive $\pi^{+}$ electroproduction off the proton}},
  \href{http://dx.doi.org/10.1103/PhysRevD.80.032004}{\emph{Phys. Rev.} {\bf
  D80} (2009) 032004}, [\href{https://arxiv.org/abs/0809.1153}{{\tt
  0809.1153}}].

\bibitem{Airapetian:2012ki}
{\scshape HERMES} collaboration, A.~Airapetian et~al., \emph{{Multiplicities of
  charged pions and kaons from semi-inclusive deep-inelastic scattering by the
  proton and the deuteron}},
  \href{http://dx.doi.org/10.1103/PhysRevD.87.074029}{\emph{Phys. Rev.} {\bf
  D87} (2013) 074029}, [\href{https://arxiv.org/abs/1212.5407}{{\tt
  1212.5407}}].

\bibitem{Aghasyan:2017ctw}
{\scshape COMPASS} collaboration, M.~Aghasyan et~al.,
  \emph{{Transverse-momentum-dependent multiplicities of charged hadrons in
  muon-deuteron deep inelastic scattering}},
  \href{http://dx.doi.org/10.1103/PhysRevD.97.032006}{\emph{Phys. Rev.} {\bf
  D97} (2018) 032006}, [\href{https://arxiv.org/abs/1709.07374}{{\tt
  1709.07374}}].

\bibitem{Bacchetta:2017gcc}
A.~Bacchetta, F.~Delcarro, C.~Pisano, M.~Radici and A.~Signori,
  \emph{{Extraction of partonic transverse momentum distributions from
  semi-inclusive deep-inelastic scattering, Drell--Yan and Z-boson
  production}}, \href{http://dx.doi.org/10.1007/JHEP06(2017)081}{\emph{JHEP}
  {\bf 06} (2017) 081}, [\href{https://arxiv.org/abs/1703.10157}{{\tt
  1703.10157}}].

\bibitem{Avakian:2010ae}
{\scshape CLAS} collaboration, H.~Avakian et~al., \emph{{Measurement of Single-
  and Double-Spin Asymmetries in Deep Inelastic Pion Electroproduction with a
  Longitudinally Polarized Target}},
  \href{http://dx.doi.org/10.1103/PhysRevLett.105.262002}{\emph{Phys. Rev.
  Lett.} {\bf 105} (2010) 262002}, [\href{https://arxiv.org/abs/1003.4549}{{\tt
  1003.4549}}].
...
D.~W. Sivers, \emph{{Single-spin production asymmetries from the hard
  scattering of pointlike constituents}},
  \href{http://dx.doi.org/10.1103/PhysRevD.41.83}{\emph{Phys. Rev.} {\bf D41}
  (1990) 83}.

\bibitem{Anselmino:2010bs}
M.~Anselmino, M.~Boglione, U.~D'Alesio, S.~Melis, F.~Murgia and A.~Prokudin,
  \emph{{New insight on the Sivers transverse momentum dependent distribution
  function}}, \href{http://dx.doi.org/10.1088/1742-6596/295/1/012062}{\emph{J.
  Phys. Conf. Ser.} {\bf 295} (2011) 012062},
  [\href{https://arxiv.org/abs/1012.3565}{{\tt 1012.3565}}].

\bibitem{Anselmino:2005ea}
M.~Anselmino, M.~Boglione, U.~D'Alesio, A.~Kotzinian, F.~Murgia and
  A.~Prokudin, \emph{{Extracting the Sivers function from polarized
  semi-inclusive deep inelastic scattering data and making predictions}},
  \href{http://dx.doi.org/10.1103/PhysRevD.72.094007,
  10.1103/PhysRevD.72.099903}{\emph{Phys. Rev.} {\bf D72} (2005) 094007},
  [\href{https://arxiv.org/abs/hep-ph/0507181}{{\tt hep-ph/0507181}}].

\bibitem{Anselmino:2005an}
M.~Anselmino et~al., \emph{{Comparing extractions of Sivers functions}},  in
  \emph{{Transversity. Proceedings, Workshop, Como, Italy, September 7-10,
  2005}}, pp.~236--243, 2005.
\newblock \href{https://arxiv.org/abs/hep-ph/0511017}{{\tt hep-ph/0511017}}.

\bibitem{Vogelsang:2005cs}
W.~Vogelsang and F.~Yuan, \emph{{Single-transverse-spin asymmetries: From deep
  inelastic scattering to hadronic collisions}},
  \href{http://dx.doi.org/10.1103/PhysRevD.72.054028}{\emph{Phys. Rev.} {\bf
  D72} (2005) 054028}, [\href{https://arxiv.org/abs/hep-ph/0507266}{{\tt
  hep-ph/0507266}}].

\bibitem{Anselmino:2008sga}
M.~Anselmino, M.~Boglione, U.~D'Alesio, A.~Kotzinian, S.~Melis, F.~Murgia
  et~al., \emph{{Sivers effect for pion and kaon production in semi-inclusive
  deep inelastic scattering}},
  \href{http://dx.doi.org/10.1140/epja/i2008-10697-y}{\emph{Eur. Phys. J.} {\bf
  A39} (2009) 89--100}, [\href{https://arxiv.org/abs/0805.2677}{{\tt
  0805.2677}}].

\bibitem{Bacchetta:2011gx}
A.~Bacchetta and M.~Radici, \emph{{Constraining Quark Angular Momentum through
  Semi-Inclusive Measurements}},
  \href{http://dx.doi.org/10.1103/PhysRevLett.107.212001}{\emph{Phys. Rev.
  Lett.} {\bf 107} (2011) 212001}, [\href{https://arxiv.org/abs/1107.5755}{{\tt
  1107.5755}}].

\bibitem{Anselmino:2011gs}
M.~Anselmino, M.~Boglione, U.~D'Alesio, S.~Melis, F.~Murgia and A.~Prokudin,
  \emph{{Sivers Distribution Functions and the Latest SIDIS Data}},  in
  \emph{{19th International Workshop on Deep-Inelastic Scattering and Related
  Subjects (DIS 2011) Newport News, Virginia, April 11-15, 2011}}, 2011.
\newblock \href{https://arxiv.org/abs/1107.4446}{{\tt 1107.4446}}.

\bibitem{Airapetian:2009ae}
{\scshape HERMES} collaboration, A.~Airapetian et~al., \emph{{Observation of
  the Naive-T-odd Sivers Effect in Deep-Inelastic Scattering}},
  \href{http://dx.doi.org/10.1103/PhysRevLett.103.152002}{\emph{Phys. Rev.
  Lett.} {\bf 103} (2009) 152002}, [\href{https://arxiv.org/abs/0906.3918}{{\tt
  0906.3918}}].

\bibitem{Adolph:2012sp}
{\scshape COMPASS} collaboration, C.~Adolph et~al., \emph{{II Experimental
  investigation of transverse spin asymmetries in $\mu$-p SIDIS processes:
  Sivers asymmetries}},
  \href{http://dx.doi.org/10.1016/j.physletb.2012.09.056}{\emph{Phys. Lett.}
  {\bf B717} (2012) 383--389}, [\href{https://arxiv.org/abs/1205.5122}{{\tt
  1205.5122}}].

\bibitem{Anselmino:2012aa}
M.~Anselmino, M.~Boglione and S.~Melis, \emph{{Strategy towards the extraction
  of the Sivers function with transverse momentum dependent evolution}},
  \href{http://dx.doi.org/10.1103/PhysRevD.86.014028}{\emph{Phys. Rev.} {\bf
  D86} (2012) 014028}, [\href{https://arxiv.org/abs/1204.1239}{{\tt
  1204.1239}}].
...
J.~C. Collins, \emph{Fragmentation of transversely polarized quarks probed in
  transverse momentum distributions}, {\emph{Nucl. Phys.} {\bf B396} (1993)
  161--182}.
...
\bibitem{Kang:2014zza}
Z.-B. Kang, A.~Prokudin, P.~Sun and F.~Yuan, \emph{{Nucleon tensor charge from
  Collins azimuthal asymmetry measurements}},
  \href{http://dx.doi.org/10.1103/PhysRevD.91.071501}{\emph{Phys. Rev.} {\bf
  D91} (2015) 071501}, [\href{https://arxiv.org/abs/1410.4877}{{\tt
  1410.4877}}].

\bibitem{Anselmino:2015sxa}
M.~Anselmino, M.~Boglione, U.~D'Alesio, J.~O. Gonzalez~Hernandez, S.~Melis,
  F.~Murgia et~al., \emph{{Collins functions for pions from SIDIS and new
  $e^+e^-$ data: a first glance at their transverse momentum dependence}},
  \href{http://dx.doi.org/10.1103/PhysRevD.92.114023}{\emph{Phys. Rev.} {\bf
  D92} (2015) 114023}, [\href{https://arxiv.org/abs/1510.05389}{{\tt
  1510.05389}}].
...
\bibitem{Barone:2009hw}
V.~Barone, S.~Melis and A.~Prokudin, \emph{{The Boer-Mulders effect in
  unpolarized SIDIS: An Analysis of the COMPASS and HERMES data on the cos2phi
  asymmetry}}, \href{http://dx.doi.org/10.1103/PhysRevD.81.114026}{\emph{Phys.
  Rev.} {\bf D81} (2010) 114026}, [\href{https://arxiv.org/abs/0912.5194}{{\tt
  0912.5194}}].

\bibitem{Airapetian:2012yg}
{\scshape HERMES} collaboration, A.~Airapetian et~al., \emph{{Azimuthal
  distributions of charged hadrons, pions, and kaons produced in deep-inelastic
  scattering off unpolarized protons and deuterons}},
  \href{http://dx.doi.org/10.1103/PhysRevD.87.012010}{\emph{Phys. Rev.} {\bf
  D87} (2013) 012010}, [\href{https://arxiv.org/abs/1204.4161}{{\tt
  1204.4161}}].

\bibitem{Adolph:2014pwc}
{\scshape COMPASS} collaboration, C.~Adolph et~al., \emph{{Measurement of
  azimuthal hadron asymmetries in semi-inclusive deep inelastic scattering off
  unpolarised nucleons}},
  \href{http://dx.doi.org/10.1016/j.nuclphysb.2014.07.019}{\emph{Nucl. Phys.}
  {\bf B886} (2014) 1046--1077}, [\href{https://arxiv.org/abs/1401.6284}{{\tt
  1401.6284}}].

\bibitem{Cahn:1978se}
R.~N. Cahn, \emph{{Azimuthal dependence in leptoproduction: A simple parton
  model calculation}},
  \href{http://dx.doi.org/10.1016/0370-2693(78)90020-5}{\emph{Phys. Lett.} {\bf
  B78} (1978) 269}.

\bibitem{Cao:2018qqf}
X.~Cao, \emph{{Parton distributions and $\cos 2\phi_h$ asymmetry induced by
  anomalous photon-quark coupling}},
  \href{http://dx.doi.org/10.1103/PhysRevD.97.114010}{\emph{Phys. Rev.} {\bf
  D97} (2018) 114010}, [\href{https://arxiv.org/abs/1802.02417}{{\tt
  1802.02417}}].

\bibitem{Barone:2010gk}
V.~Barone, S.~Melis and A.~Prokudin, \emph{{Azimuthal asymmetries in
  unpolarized Drell--Yan processes and the Boer--Mulders distributions of
  antiquarks}}, \href{http://dx.doi.org/10.1103/PhysRevD.82.114025}{\emph{Phys.
  Rev.} {\bf D82} (2010) 114025}, [\href{https://arxiv.org/abs/1009.3423}{{\tt
  1009.3423}}].

\bibitem{Barone:2015ksa}
V.~Barone, M.~Boglione, J.~O. Gonzalez~Hernandez and S.~Melis,
  \emph{{Phenomenological analysis of azimuthal asymmetries in unpolarized
  semi-inclusive deep inelastic scattering}},
  \href{http://dx.doi.org/10.1103/PhysRevD.91.074019}{\emph{Phys. Rev.} {\bf
  D91} (2015) 074019}, [\href{https://arxiv.org/abs/1502.04214}{{\tt
  1502.04214}}].

\bibitem{Avakian:2008dz}
H.~Avakian, A.~V. Efremov, P.~Schweitzer and F.~Yuan, \emph{{Transverse
  momentum dependent distribution function $h_{1T}^\perp$ and the single spin
  asymmetry $A_{UT}^{\sin(3\phi-\phi_S)}$}},
  \href{http://dx.doi.org/10.1103/PhysRevD.78.114024}{\emph{Phys. Rev.} {\bf
  D78} (2008) 114024}, [\href{https://arxiv.org/abs/0805.3355}{{\tt
  0805.3355}}].

\bibitem{She:2009jq}
J.~She, J.~Zhu and B.-Q. Ma, \emph{{$h_{1T}^{\perp}$ and quark orbital angular
  momentum}}, \href{http://dx.doi.org/10.1103/PhysRevD.79.054008}{\emph{Phys.
  Rev.} {\bf D79} (2009) 054008}, [\href{https://arxiv.org/abs/0902.3718}{{\tt
  0902.3718}}].

\bibitem{Lorce:2011kn}
C.~Lorce and B.~Pasquini, \emph{{The pretzelosity TMD and quark orbital angular
  momentum}},
  \href{http://dx.doi.org/10.1016/j.physletb.2012.03.025}{\emph{Phys. Lett.}
  {\bf B710} (2012) 486--488}, [\href{https://arxiv.org/abs/1111.6069}{{\tt
  1111.6069}}].
...
\bibitem{Schnell:2010zza}
{\scshape HERMES} collaboration, G.~Schnell, \emph{{The Sivers and other
  semi-inclusive single-spin asymmetries at HERMES}},
  \href{http://dx.doi.org/10.22323/1.106.0247}{\emph{PoS} {\bf DIS2010} (2010)
  247}.

\bibitem{Lefky:2014eia}
C.~Lefky and A.~Prokudin, \emph{{Extraction of the distribution function
  $h^{\perp}_{1T}$ from experimental data}},
  \href{http://dx.doi.org/10.1103/PhysRevD.91.034010}{\emph{Phys. Rev.} {\bf
  D91} (2015) 034010}, [\href{https://arxiv.org/abs/1411.0580}{{\tt
  1411.0580}}].

\bibitem{Kotzinian:2008fe}
A.~Kotzinian, \emph{{SIDIS Asymmetries in Quark-Diquark Model}},  in
  \emph{{Transversity 2008: 2nd International Workshop on Transverse
  Polarization Phenomena in Hard Processes Ferrara, Italy, May 28-31, 2008}},
  2008.
\newblock \href{https://arxiv.org/abs/0806.3804}{{\tt 0806.3804}}.

\bibitem{Boffi:2009sh}
S.~Boffi, A.~V. Efremov, B.~Pasquini and P.~Schweitzer, \emph{{Azimuthal spin
  asymmetries in light-cone constituent quark models}},
  \href{http://dx.doi.org/10.1103/PhysRevD.79.094012}{\emph{Phys. Rev.} {\bf
  D79} (2009) 094012}, [\href{https://arxiv.org/abs/0903.1271}{{\tt
  0903.1271}}].

\bibitem{Ball:2014uwa}
{\scshape NNPDF} collaboration, R.~D. Ball et~al., \emph{{Parton distributions
  for the LHC Run II}},
  \href{http://dx.doi.org/10.1007/JHEP04(2015)040}{\emph{JHEP} {\bf 04} (2015)
  040}, [\href{https://arxiv.org/abs/1410.8849}{{\tt 1410.8849}}].

\bibitem{Huang:2011bc}
{\scshape Jefferson Lab Hall A} collaboration, J.~Huang et~al.,
  \emph{{Beam-Target Double Spin Asymmetry $A_{LT}$ in Charged Pion Production
  from Deep Inelastic Scattering on a Transversely Polarized $^{3}$He Target at
  $1.4 < Q^2 < 2.7 GeV^2$}},
  \href{http://dx.doi.org/10.1103/PhysRevLett.108.052001}{\emph{Phys. Rev.
  Lett.} {\bf 108} (2012) 052001}, [\href{https://arxiv.org/abs/1108.0489}{{\tt
  1108.0489}}].

\bibitem{Parsamyan:2007ju}
{\scshape COMPASS} collaboration, B.~Parsamyan, \emph{{New target transverse
  spin dependent azimuthal asymmetries from COMPASS experiment}},
  \href{http://dx.doi.org/10.1140/epjst/e2008-00780-1}{\emph{Eur. Phys. J. ST}
  {\bf 162} (2008) 89--96}, [\href{https://arxiv.org/abs/0709.3440}{{\tt
  0709.3440}}].

\bibitem{Parsamyan:2015dfa}
{\scshape COMPASS} collaboration, B.~Parsamyan, \emph{{Transverse spin
  azimuthal asymmetries in SIDIS at COMPASS: Multidimensional analysis}},
  \href{http://dx.doi.org/10.1142/S2010194516600296}{\emph{Int. J. Mod. Phys.
  Conf. Ser.} {\bf 40} (2016) 1660029},
  [\href{https://arxiv.org/abs/1504.01599}{{\tt 1504.01599}}].

\bibitem{Parsamyan:2018evv}
{\scshape COMPASS} collaboration, B.~Parsamyan, \emph{{Measurement of
  target-polarization dependent azimuthal asymmetries in SIDIS and Drell-Yan
  processes at COMPASS experiment}}, {\emph{PoS} {\bf QCDEV2017} (2018) 042}.

\bibitem{Pappalardo:2011cu}
{\scshape HERMES} collaboration, L.~L. Pappalardo and M.~Diefenthaler,
  \emph{{Measurements of Double-Spin Asymmetries in SIDIS of Longitudinally
  Polarized Leptons off Transversely Polarized Protons}},
  \href{https://arxiv.org/abs/1107.4227}{{\tt 1107.4227}}.

\bibitem{Pappalardo:2012zz}
{\scshape HERMES} collaboration, L.~L. Pappalardo, \emph{{Accessing TMDs at
  HERMES}}, \href{http://dx.doi.org/10.1063/1.3700519}{\emph{AIP Conf. Proc.}
  {\bf 1441} (2012) 229--232}.

\bibitem{Airapetian:1999tv}
{\scshape HERMES} collaboration, A.~Airapetian et~al., \emph{{Evidence for a
  Single-Spin Azimuthal Asymmetry in Semi-inclusive Pion Electroproduction}},
  \href{http://dx.doi.org/10.1103/PhysRevLett.84.4047}{\emph{Phys. Rev. Lett.}
  {\bf 84} (2000) 4047--4051},
  [\href{https://arxiv.org/abs/hep-ex/9910062}{{\tt hep-ex/9910062}}].

\bibitem{Parsamyan:2018ovx}
{\scshape COMPASS} collaboration, B.~Parsamyan, \emph{{Measurement of
  longitudinal-target-polarization dependent azimuthal asymmetries in SIDIS at
  COMPASS experiment}}, {\emph{PoS} {\bf DIS2017} (2018) 259},
  [\href{https://arxiv.org/abs/1801.01488}{{\tt 1801.01488}}].

\bibitem{Jawalkar:2017ube}
{\scshape CLAS} collaboration, S.~Jawalkar et~al., \emph{{Semi-Inclusive
  $\pi^0$ target and beam-target asymmetries from 6 GeV electron scattering
  with CLAS}},
  \href{http://dx.doi.org/10.1016/j.physletb.2018.06.014}{\emph{Phys. Lett.}
  {\bf B782} (2018) 662--667}, [\href{https://arxiv.org/abs/1709.10054}{{\tt
  1709.10054}}].

\bibitem{Airapetian:2002mf}
{\scshape HERMES} collaboration, A.~Airapetian et~al., \emph{{Measurement of
  single-spin azimuthal asymmetries in semi-inclusive electroproduction of
  pions and kaons on a longitudinally polarised deuterium target}},
  \href{http://dx.doi.org/10.1016/S0370-2693(03)00566-5}{\emph{Phys. Lett.}
  {\bf B562} (2003) 182--192},
  [\href{https://arxiv.org/abs/hep-ex/0212039}{{\tt hep-ex/0212039}}].

\bibitem{Avakian:2003pk}
{\scshape CLAS} collaboration, H.~Avakian et~al., \emph{{Measurement of
  beam-spin asymmetries for $\pi^{+}$ electroproduction above the baryon
  resonance region}},
  \href{http://dx.doi.org/10.1103/PhysRevD.69.112004}{\emph{Phys. Rev.} {\bf
  D69} (2004) 112004}, [\href{https://arxiv.org/abs/hep-ex/0301005}{{\tt
  hep-ex/0301005}}].

\bibitem{Airapetian:2006rx}
{\scshape HERMES} collaboration, A.~Airapetian et~al., \emph{Beam-spin
  asymmetries in the azimuthal distribution of pion electroproduction},
  \href{http://dx.doi.org/10.1016/j.physletb.2007.03.015}{\emph{Phys. Lett.}
  {\bf B648} (2007) 164--170},
  [\href{https://arxiv.org/abs/hep-ex/0612059}{{\tt hep-ex/0612059}}].

\bibitem{Gohn:2009zz}
W.~Gohn, H.~Avakian, K.~Joo and M.~Ungaro, \emph{{Beam spin asymmetries from
  semi-inclusive pion electroproduction in deep inelastic scattering}},
  \href{http://dx.doi.org/10.1063/1.3215689}{\emph{AIP Conf. Proc.} {\bf 1149}
  (2009) 461--464}.

\bibitem{Aghasyan:2011ha}
M.~Aghasyan, H.~Avakian, P.~Rossi, E.~De~Sanctis, D.~Hasch et~al.,
  \emph{Precise measurements of beam spin asymmetries in semi-inclusive $\pi^0$
  production},
  \href{http://dx.doi.org/10.1016/j.physletb.2011.09.044}{\emph{Phys. Lett.}
  {\bf B704} (2011) 397--402}, [\href{https://arxiv.org/abs/1106.2293}{{\tt
  1106.2293}}].

\bibitem{Gohn:2014zbz}
{\scshape CLAS} collaboration, W.~Gohn et~al., \emph{{Beam-spin asymmetries
  from semi-inclusive pion electroproduction}},
  \href{http://dx.doi.org/10.1103/PhysRevD.89.072011}{\emph{Phys. Rev.} {\bf
  D89} (2014) 072011}, [\href{https://arxiv.org/abs/1402.4097}{{\tt
  1402.4097}}].

\bibitem{Efremov:2002ut}
A.~V. Efremov, K.~Goeke and P.~Schweitzer, \emph{{Azimuthal asymmetries at
  CLAS: Extraction of $e^{a}(x)$ and prediction of $A_{UL}$}},
  \href{http://dx.doi.org/10.1103/PhysRevD.67.114014}{\emph{Phys. Rev.} {\bf
  D67} (2003) 114014}, [\href{https://arxiv.org/abs/hep-ph/0208124}{{\tt
  hep-ph/0208124}}].

\bibitem{Afanasev:2003ze}
A.~Afanasev and C.~E. Carlson, \emph{{Single spin beam asymmetry in
  semiexclusive deep inelastic electroproduction}},  in \emph{{Intersections of
  particle and nuclear physics. Proceedings, 8th Conference, CIPANP 2003, New
  York, USA, May 19-24, 2003}}, 2003.
\newblock \href{https://arxiv.org/abs/hep-ph/0308163}{{\tt hep-ph/0308163}}.

\bibitem{Yuan:2003gu}
F.~Yuan, \emph{{The Beam single spin asymmetry in semi-inclusive deep inelastic
  scattering}},
  \href{http://dx.doi.org/10.1016/j.physletb.2004.03.040}{\emph{Phys. Lett.}
  {\bf B589} (2004) 28--34}, [\href{https://arxiv.org/abs/hep-ph/0310279}{{\tt
  hep-ph/0310279}}].

\bibitem{Gamberg:2003pz}
L.~P. Gamberg, D.~S. Hwang and K.~A. Oganessyan, \emph{{Chiral-odd
  fragmentation functions in single pion inclusive electroproduction}},
  \href{http://dx.doi.org/10.1016/j.physletb.2004.01.054}{\emph{Phys. Lett.}
  {\bf B584} (2004) 276--284},
  [\href{https://arxiv.org/abs/hep-ph/0311221}{{\tt hep-ph/0311221}}].

\bibitem{Afanasev:2006gw}
A.~V. Afanasev and C.~E. Carlson, \emph{Beam single-spin asymmetry in
  semiinclusive deep inelastic scattering},
  \href{http://dx.doi.org/10.1103/PhysRevD.74.114027}{\emph{Phys. Rev.} {\bf
  D74} (2006) 114027}, [\href{https://arxiv.org/abs/hep-ph/0603269}{{\tt
  hep-ph/0603269}}].

\bibitem{Mao:2012dk}
W.~Mao and Z.~Lu, \emph{{Beam single spin asymmetry of neutral pion production
  in semi-inclusive deep inelastic scattering}},
  \href{http://dx.doi.org/10.1103/PhysRevD.87.014012}{\emph{Phys. Rev.} {\bf
  D87} (2013) 014012}, [\href{https://arxiv.org/abs/1210.4790}{{\tt
  1210.4790}}].

\bibitem{Mao:2013waa}
W.~Mao and Z.~Lu, \emph{{Beam spin asymmetries of charged and neutral pion
  production in semi-inclusive DIS}},
  \href{http://dx.doi.org/10.1140/epjc/s10052-013-2557-9}{\emph{Eur. Phys. J.}
  {\bf C73} (2013) 2557}, [\href{https://arxiv.org/abs/1306.1004}{{\tt
  1306.1004}}].

\bibitem{Mao:2014dva}
W.~Mao and Z.~Lu, \emph{{On the beam spin asymmetries of electroproduction of
  charged hadrons off the nucleon targets}},
  \href{http://dx.doi.org/10.1140/epjc/s10052-014-2910-7}{\emph{Eur. Phys. J.}
  {\bf C74} (2014) 2910}, [\href{https://arxiv.org/abs/1401.4653}{{\tt
  1401.4653}}].

\bibitem{Courtoy:2014ixa}
A.~Courtoy, \emph{{Insights into the higher-twist distribution $e(x)$ at
  CLAS}},  \href{https://arxiv.org/abs/1405.7659}{{\tt 1405.7659}}.

\bibitem{Yang:2016mxl}
Y.~Yang, Z.~Lu and I.~Schmidt, \emph{{Twist-3 T-odd fragmentation functions
  $G^\perp$ and $\tilde{G}^\perp$ in a spectator model}},
  \href{http://dx.doi.org/10.1016/j.physletb.2016.08.053}{\emph{Phys. Lett.}
  {\bf B761} (2016) 333--339}, [\href{https://arxiv.org/abs/1607.01638}{{\tt
  1607.01638}}].

\bibitem{Pasquini:2018oyz}
B.~Pasquini and S.~Rodini, \emph{{The twist-three distribution $e^q(x,k_\perp)$
  in a light-front model}},
  \href{http://dx.doi.org/10.1016/j.physletb.2018.11.033}{\emph{Phys. Lett.}
  {\bf B788} (2019) 414--424}, [\href{https://arxiv.org/abs/1806.10932}{{\tt
  1806.10932}}].

\bibitem{Mao:2014fma}
W.~Mao, Z.~Lu, B.-Q. Ma and I.~Schmidt, \emph{{Double spin asymmetries
  $A_{LT}^{\cos\phi_S}$ and $A_{LT}^{\cos(2\phi_h -\phi_S)}$ in semi-inclusive
  DIS}}, \href{http://dx.doi.org/10.1103/PhysRevD.91.034029}{\emph{Phys. Rev.}
  {\bf D91} (2015) 034029}, [\href{https://arxiv.org/abs/1412.7390}{{\tt
  1412.7390}}].

\bibitem{Wang:2016dti}
X.~Wang, W.~Mao and Z.~Lu, \emph{{Double-spin asymmetry $A^{\cos\phi_S}_{LT}$
  in semi-inclusive DIS at CLAS12 and EIC within the collinear framework}},
  \href{http://dx.doi.org/10.1103/PhysRevD.94.074014}{\emph{Phys. Rev.} {\bf
  D94} (2016) 074014}, [\href{https://arxiv.org/abs/1606.01649}{{\tt
  1606.01649}}].

\bibitem{Anselmino:2006yc}
M.~Anselmino, A.~Efremov, A.~Kotzinian and B.~Parsamyan, \emph{{Transverse
  momentum dependence of the quark helicity distributions and the Cahn effect
  in double-spin asymmetry $A_{LL}$ in semi inclusive DIS}},
  \href{http://dx.doi.org/10.1103/PhysRevD.74.074015}{\emph{Phys. Rev.} {\bf
  D74} (2006) 074015}, [\href{https://arxiv.org/abs/hep-ph/0608048}{{\tt
  hep-ph/0608048}}].

\bibitem{Mao:2016hdi}
W.~Mao, X.~Wang, X.~Du, Z.~Lu and B.-Q. Ma, \emph{{On the cos $\phi_h$
  asymmetry in electroproduction of pions in double longitudinally polarized
  process}},
  \href{http://dx.doi.org/10.1016/j.nuclphysa.2015.10.004}{\emph{Nucl. Phys.}
  {\bf A945} (2016) 153--167}.

\bibitem{Airapetian:2001eg}
{\scshape HERMES} collaboration, A.~Airapetian et~al., \emph{{Single-spin
  azimuthal asymmetries in electroproduction of neutral pions in semi-inclusive
  deep-inelastic scattering}},
  \href{http://dx.doi.org/10.1103/PhysRevD.64.097101}{\emph{Phys. Rev.} {\bf
  D64} (2001) 097101}, [\href{https://arxiv.org/abs/hep-ex/0104005}{{\tt
  hep-ex/0104005}}].

\bibitem{DeSanctis:2000fh}
E.~De~Sanctis, W.~D. Nowak and K.~A. Oganesian, \emph{{Single-spin azimuthal
  asymmetries in the ``Reduced twist-3 approximation''}},
  \href{http://dx.doi.org/10.1016/S0370-2693(00)00596-7}{\emph{Phys. Lett.}
  {\bf B483} (2000) 69--73}, [\href{https://arxiv.org/abs/hep-ph/0002091}{{\tt
  hep-ph/0002091}}].

\bibitem{Oganessian:2000um}
K.~A. Oganessian, N.~Bianchi, E.~De~Sanctis and W.~D. Nowak,
  \emph{{Investigation of single spin asymmetries in $\pi^{+}$
  electroproduction}},
  \href{http://dx.doi.org/10.1016/S0375-9474(00)00609-6}{\emph{Nucl. Phys.}
  {\bf A689} (2001) 784--792},
  [\href{https://arxiv.org/abs/hep-ph/0010261}{{\tt hep-ph/0010261}}].

\bibitem{Efremov:2001ia}
A.~V. Efremov, K.~Goeke and P.~Schweitzer, \emph{{Predictions for azimuthal
  asymmetries in pion and kaon production in SIDIS off a longitudinally
  polarized deuterium target at HERMES}},
  \href{http://dx.doi.org/10.1007/s100520200918}{\emph{Eur. Phys. J.} {\bf C24}
  (2002) 407--412}, [\href{https://arxiv.org/abs/hep-ph/0112166}{{\tt
  hep-ph/0112166}}].

\bibitem{Efremov:2002td}
A.~V. Efremov, K.~Goeke and P.~Schweitzer, \emph{{Azimuthal asymmetry in
  electroproduction of neutral pions in semiinclusive DIS}},
  \href{http://dx.doi.org/10.1016/S0370-2693(01)01258-8,
  10.1016/S0370-2693(02)02518-2}{\emph{Phys. Lett.} {\bf B522} (2001) 37--48},
  [\href{https://arxiv.org/abs/hep-ph/0108213}{{\tt hep-ph/0108213}}].

\bibitem{Efremov:2002sd}
A.~V. Efremov, K.~Goeke and P.~Schweitzer, \emph{{Azimuthal asymmetries and
  Collins analyzing power}},
  \href{http://dx.doi.org/10.1016/S0375-9474(02)01199-5}{\emph{Nucl. Phys.}
  {\bf A711} (2002) 84--88}, [\href{https://arxiv.org/abs/hep-ph/0206267}{{\tt
  hep-ph/0206267}}].

\bibitem{Ma:2001ie}
B.-Q. Ma, I.~Schmidt and J.-J. Yang, \emph{{Azimuthal spin asymmetries of pion
  electroproduction}},
  \href{http://dx.doi.org/10.1103/PhysRevD.65.034010}{\emph{Phys. Rev.} {\bf
  D65} (2002) 034010}, [\href{https://arxiv.org/abs/hep-ph/0110324}{{\tt
  hep-ph/0110324}}].

\bibitem{Ma:2002ns}
B.-Q. Ma, I.~Schmidt and J.-J. Yang, \emph{{Reanalysis of azimuthal spin
  asymmetries of meson electroproduction}},
  \href{http://dx.doi.org/10.1103/PhysRevD.66.094001}{\emph{Phys. Rev.} {\bf
  D66} (2002) 094001}, [\href{https://arxiv.org/abs/hep-ph/0209114}{{\tt
  hep-ph/0209114}}].

\bibitem{Schweitzer:2003yr}
P.~Schweitzer and A.~Bacchetta, \emph{{Azimuthal single spin asymmetries in
  SIDIS in the light of chiral symmetry breaking}},
  \href{http://dx.doi.org/10.1016/j.nuclphysa.2003.12.010}{\emph{Nucl. Phys.}
  {\bf A732} (2004) 106--124},
  [\href{https://arxiv.org/abs/hep-ph/0310318}{{\tt hep-ph/0310318}}].

\bibitem{Lu:2014fva}
Z.~Lu, \emph{{Single-spin asymmetries in electroproduction of pions on the
  longitudinally polarized nucleon targets}},
  \href{http://dx.doi.org/10.1103/PhysRevD.90.014037}{\emph{Phys. Rev.} {\bf
  D90} (2014) 014037}, [\href{https://arxiv.org/abs/1404.4229}{{\tt
  1404.4229}}].

\bibitem{Airapetian:2005jc}
{\scshape HERMES} collaboration, A.~Airapetian et~al., \emph{{Subleading-twist
  effects in single-spin asymmetries in semi-inclusive deep-inelastic
  scattering on a longitudinally polarized hydrogen target}},
  \href{http://dx.doi.org/10.1016/j.physletb.2005.06.067}{\emph{Phys. Lett.}
  {\bf B622} (2005) 14--22}, [\href{https://arxiv.org/abs/hep-ex/0505042}{{\tt
  hep-ex/0505042}}].

\bibitem{Mao:2014aoa}
W.~Mao, Z.~Lu and B.-Q. Ma, \emph{{Transverse single-spin asymmetries of pion
  production in semi-inclusive DIS at subleading twist}},
  \href{http://dx.doi.org/10.1103/PhysRevD.90.014048}{\emph{Phys. Rev.} {\bf
  D90} (2014) 014048}, [\href{https://arxiv.org/abs/1405.3876}{{\tt
  1405.3876}}].

\bibitem{Cheng:1972sy}
T.~P. Cheng and A.~Zee, \emph{{Coincidence Electroproduction and Scaling in the
  Regge Region}}, \href{http://dx.doi.org/10.1103/PhysRevD.6.885}{\emph{Phys.
  Rev.} {\bf D6} (1972) 885--893}.

\bibitem{Aubert:1983cz}
{\scshape European Muon} collaboration, J.~J. Aubert et~al., \emph{Measurement
  of hadronic azimuthal distributions in deep inelastic muon proton
  scattering},
  \href{http://dx.doi.org/10.1016/0370-2693(83)91076-6}{\emph{Phys. Lett.} {\bf
  130B} (1983) 118--122}.

\bibitem{Dakin:1972db}
J.~T. Dakin, G.~J. Feldman, W.~L. Lakin, F.~Martin, M.~L. Perl, E.~W. Petraske
  et~al., \emph{Preliminary results on the inclusive electroproduction of
  hadrons},  1972.

\bibitem{Mkrtchyan:2007sr}
H.~Mkrtchyan, P.~Bosted, G.~Adams, A.~Ahmidouch, T.~Angelescu et~al.,
  \emph{{Transverse momentum dependence of semi-inclusive pion production}},
  \href{http://dx.doi.org/10.1016/j.physletb.2008.05.047}{\emph{Phys. Lett.}
  {\bf B665} (2008) 20--25}, [\href{https://arxiv.org/abs/0709.3020}{{\tt
  0709.3020}}].

\bibitem{Anselmino:2011ch}
M.~Anselmino, M.~Boglione, U.~D'Alesio, S.~Melis, F.~Murgia et~al.,
  \emph{General helicity formalism for polarized semi-inclusive deep inelastic
  scattering}, \href{http://dx.doi.org/10.1103/PhysRevD.83.114019}{\emph{Phys.
  Rev.} {\bf D83} (2011) 114019}, [\href{https://arxiv.org/abs/1101.1011}{{\tt
  1101.1011}}].

\bibitem{Efremov:2004tp}
A.~V. Efremov, K.~Goeke, S.~Menzel, A.~Metz and P.~Schweitzer, \emph{{Sivers
  effect in semi-inclusive DIS and in the Drell--Yan process}},
  \href{http://dx.doi.org/10.1016/j.physletb.2005.03.010}{\emph{Phys. Lett.}
  {\bf B612} (2005) 233--244},
  [\href{https://arxiv.org/abs/hep-ph/0412353}{{\tt hep-ph/0412353}}].

\bibitem{Gamberg:2013kla}
L.~Gamberg, Z.-B. Kang and A.~Prokudin, \emph{{Indication on the Process
  Dependence of the Sivers Effect}},
  \href{http://dx.doi.org/10.1103/PhysRevLett.110.232301}{\emph{Phys. Rev.
  Lett.} {\bf 110} (2013) 232301}, [\href{https://arxiv.org/abs/1302.3218}{{\tt
  1302.3218}}].

\bibitem{Sun:2013dya}
P.~Sun and F.~Yuan, \emph{{Energy evolution for the Sivers asymmetries in hard
  processes}}, \href{http://dx.doi.org/10.1103/PhysRevD.88.034016}{\emph{Phys.
  Rev.} {\bf D88} (2013) 034016}, [\href{https://arxiv.org/abs/1304.5037}{{\tt
  1304.5037}}].

\bibitem{Gluck:2000dy}
M.~Gl{\"u}ck, E.~Reya, M.~Stratmann and W.~Vogelsang, \emph{{Models for the
  polarized parton distributions of the nucleon}},
  \href{http://dx.doi.org/10.1103/PhysRevD.63.094005}{\emph{Phys. Rev.} {\bf
  D63} (2001) 094005}, [\href{https://arxiv.org/abs/hep-ph/0011215}{{\tt
  hep-ph/0011215}}].
