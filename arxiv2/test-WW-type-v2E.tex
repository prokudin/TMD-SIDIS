...
functions $g_1^a(x)$ and $h_1^a(x)$. This point is of not much
...
\caption{\label{aut_h1_jlab}  Collins asymmetry
	...
	\ps{(b)} COMPASS \cite{Adolph:2014zba} data [where
	$(-1)A_{UT}^{\sin(\phi_h+\phi_S)}$ is shown since COMPASS 
	\gs{uses an opposite sign in its Collins asymmetry convention}].}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\caption{\label{aut_h1tp_jlab} $A_{UT}^{\sin(3 \phi_h - \phi_S)}$
	...
	%only in the figures exactly as provided by COMPASS collaboration in 
...
\includegraphics[height=5.5cm]{\FigPath/A_UL2_Pr0711_Zgt02.pdf} \\
...
\includegraphics[height=4cm]{\FigPath/AULsin2phi_JLAB_x.pdf} \
\includegraphics[height=4cm]{\FigPath/AULsin2phi_COMPASS_x} \\
...
\caption{\label{autsin2phihphis}
	...
	preliminary COMPASS data~\cite{Parsamyan:2013fia} (a,b)
 %\ps{and our calculation for this kinematics (c) shown separately}.
