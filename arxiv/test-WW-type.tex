...
\ee
and the asymmetries $A_{XY}^{\rm weight}$,  are defined in terms of structure functions $F_{XY}^{\rm weight}$, as follows
\be
...
\be\label{Eq:correlator}
	...
	{\cal W}_{(\infty,\xi)}\,\psi_i(\xi)|N(P,S)\ra
    	\with{ }{\xi^+\!=\!0}{$k^+ = xP^+$}
	\ee
where the Wilson-lines ${\cal W}_{(0,\,\infty)}
...
Notice that Ref.~\cite{Bacchetta:2006tn} uses four-vector notations for transverse vectors, while in this paper we always utilize two-vectors for transverse vectors, such that e.g. ${\bfkperp^2}_{\rm our} = -{{p}_T^2}_{\mbox{\rm Ref.\citep{Bacchetta:2006tn}}}$ and analog for other scalar products of {\it transverse} vectors.},
...
as presented in this paper. This assumption holds if renormalization is multiplicative and
   flavor-independent for the non-local lattice operators. This is
   not true for all lattice actions [64]. But presumably it is true
   if the lattice action preserves chiral symmetry, as it does in
   the present case. For the latest developments we refer the
   interested reader to Refs.~\cite{Alexandrou:2017dzj,Ishikawa:2017faj,Ji:2017oey,Yoon:2017qzo,Green:2017xeu,Zhang:2017bzy}.
...
in terms of the basis functions\footnote{Notice that SIDIS alone is of course not sufficient to determine
...
\begin{figure}[b]
\centering 
\includegraphics[width=0.45\textwidth]{\FigPath/all_jlab_pip}  
\includegraphics[width=0.45\textwidth]{\FigPath/all_jlab_pi0}  
\includegraphics[width=0.45\textwidth]{\FigPath/all_jlab_pim} 
...
on respectively charged pion and hadron production from a proton target. Notice that COMPASS points are lower than theoretical calculation, that may indicate evolution effects~\cite{Aybat:2011ta, Anselmino:2012aa}.
...
The $F_{UT}^{\sin(\phi_h+\phi_S)}$ structure function of the SIDIS cross section is due 
...
Radici:2015mwa,Radici:2018iag}. The first polarized Drell-Yan data were measured by COMPASS~\cite{Aghasyan:2017jop,Parsamyan:2018zju}.
...
the Collins fragmention function and the Boer-Mulders TMD $h_{1}^{\perp q}$ which describes
...
the data well, especially for COMPASS one can see that calculation and the data are of opposite signs. In fact, it is suspected that this observable receives 
...
\begin{figure}[b!]
\centering
\includegraphics[width=0.45\textwidth]{\FigPath/UT_Pr10_pretzelosity_pip.pdf}  
\includegraphics[width=0.45\textwidth]{\FigPath/UT_Pr10_pretzelosity_pim.pdf}
\includegraphics[width=0.55\textwidth]{\FigPath/AUTPretzelosity_HERMES_x.pdf}
...
\begin{figure}[b!]
\centering
\includegraphics[width=0.45\textwidth]{\FigPath/LT_Pr10_cosphihphis_pip}
\includegraphics[width=0.45\textwidth]{\FigPath/LT_Pr10_cosphihphis_pim}
...
\begin{figure}[b!]
\centering
\includegraphics[width=0.9\textwidth]{\FigPath/A_UL2_Pr0711_Zgt02.pdf} \quad
\includegraphics[width=0.55\textwidth]{\FigPath/AULsin2phi_JLAB_x.pdf} 
\vspace{-5mm}
...
Aghasyan:2011ha,Adolph:2014pwc,Gohn:2014zbz}, these 2\% come after $1/Q$ suppression. Unsuppressed effect at large $x$ at COMPASS would reach 10\% \cite{private}.
...
\begin{figure}[htb!]
\centering
\includegraphics[width=0.45\textwidth]{\FigPath/LT_Pr10_cosphis_pip.pdf} 
\includegraphics[width=0.45\textwidth]{\FigPath/LT_Pr10_cosphis_pim.pdf} 
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.45\textwidth]{\FigPath/LT_Pr10_cos2phihphis_pip}
\includegraphics[width=0.45\textwidth]{\FigPath/LT_Pr10_cos2phihphis_pim} 
...
\centering
%\vspace{1cm}
\includegraphics[width=0.9\textwidth]{\FigPath/A_LL_Pr0711_Zgt02.pdf}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.45\textwidth]{\FigPath/UT_Pr10_sinphis_pip.pdf}
\includegraphics[width=0.45\textwidth]{\FigPath/UT_Pr10_sinphis_pim.pdf}
\includegraphics[width=0.55\textwidth]{\FigPath/AUTsinphiS_HERMES_x.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.45\textwidth]{\FigPath/UT_Pr10_sin2phihphis_pip}
\includegraphics[width=0.45\textwidth]{\FigPath/UT_Pr10_sin2phihphis_pip}
\includegraphics[width=0.55\textwidth]{\FigPath/AUTsin2PhiminusPhiS_HERMES_x.pdf}
...
B.~Parsamyan, \emph{{First measurement of transverse-spin-dependent azimuthal
  asymmetries in the Drell-Yan process}}, {\emph{PoS} {\bf DIS2017} (2018)
...
\bibitem{Parsamyan:2010se}
B.~Parsamyan, \emph{{Transverse spin dependent azimuthal asymmetries at
  COMPASS}}, {\emph{J. Phys. Conf. Ser.} {\bf 295} (2011) 012046},
  [\href{https://arxiv.org/abs/1012.0155}{{\tt 1012.0155}}].
...
B.~Parsamyan, \emph{{Measurement of target-polarization dependent azimuthal
  asymmetries in SIDIS and Drell-Yan processes at COMPASS experiment}},
  {\emph{PoS} {\bf QCDEV2017} (2018) 042}.

\bibitem{Parsamyan:2015dfa}
B.~Parsamyan, \emph{{Transverse spin azimuthal asymmetries in SIDIS at COMPASS:
...
B.~Parsamyan, \emph{{Transverse spin asymmetries at COMPASS: beyond Collins and
  Sivers effects}}, {\emph{PoS} {\bf DIS2013} (2013) 231},
  [\href{https://arxiv.org/abs/1307.0183}{{\tt 1307.0183}}].

\bibitem{Parsamyan:2018ovx}
B.~Parsamyan, \emph{{Measurement of longitudinal-target-polarization dependent
  azimuthal asymmetries in SIDIS at COMPASS experiment}}, {\emph{PoS} {\bf
  DIS2017} (2018) 259}, [\href{https://arxiv.org/abs/1801.01488}{{\tt
  1801.01488}}].
...
\bibitem{private}
\emph{{Private communications with B. Parsamyan}}, .
...
\bibitem{Courtoy:2014xea}
A.~Courtoy, \emph{{Phenomenology of hadron structure --- why low energy physics
  matters}}, \href{http://dx.doi.org/10.1088/1742-6596/651/1/012007}{\emph{J.
  Phys. Conf. Ser.} {\bf 651} (2015) 012007},
  [\href{https://arxiv.org/abs/1405.6567}{{\tt 1405.6567}}].
