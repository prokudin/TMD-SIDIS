...
in terms of the basis functions. \AP{Notice that SIDIS alone is of course not sufficient to determine
   ...
   of $f_1^a$ and $D_1^a$).}
%\AP{Notice that SIDIS alone is of course not sufficient to determine the basis
%functions uniquely: the 8 basis functions appear in 6 \AP{leading-twist} SIDIS structure functions.
