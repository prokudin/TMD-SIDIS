...
\preprint{\red{version ``01a''}; \today; JLAB-THY-18-2775}
...
phenomenology and for event generators, and will help \AP{to improve the description of
semi-inclusive deep-inelastic processes in terms of transverse momentum
...
phenomenological fits with evolution \cite{Aybat:2011ta,Kang:2015msa}. \AP{In particular, the studies of matching of collinear and TMD quantities was performed 
at leading twist-2 level at NLO and NNLO in ~\cite{Gutierrez-Reyes:2017glx} and ~\cite{Gutierrez-Reyes:2018qez} accordingly, and it was shown that evolution of higher twist operators is generically different from the leading twist ones.} \AP{The Wandzura--Wilczek approximation has been used recently for for TMD Sivers, Boer-Mulders and worm-gear functions observables in Ref.~\cite{Scimemi:2018mmi} to connect TMDs and higher twist collinear matrix elements}.
...
as presented in this paper. \AP{This assumption holds if renormalization is multiplicative and
...
in terms of the basis functions\footnote{\AP{Notice that SIDIS alone is of course not sufficient to determine
