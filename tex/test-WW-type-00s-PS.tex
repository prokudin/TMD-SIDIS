...
\author[e,f]{A.~Kotzinian} 
\author[g]{B.~U.~Musch} 
\author[e]{B.~Parsamyan} 
\author[b,c]{A.~Prokudin} 
\author[i]{M.~Schlegel} 
\author[]{G.~Schnell} 
\author[a,i]{P.~Schweitzer} 
\author[i]{W.~Vogelsang} 
...
\affiliation[d]{Joint Institute for Nuclear Research, Dubna, 
	141980 Russia}
\affiliation[e]{Yerevan Physics Institute,
2 Alikhanyan Brothers St.,
375036 Yerevan, Armenia
}
\affiliation[f]{INFN, Sezione di Torino, 10125 Torino, Italy
}

\affiliation[g]{Institut f\"ur Theoretische Physik, Universit\"at 
  	Regensburg, 93040 Regensburg, Germany}
\affiliation[i]{Institute for Theoretical Physics, Universit\"at T\"ubingen,
...
The asymmetries $A_{UL}^{\sin(2\phi_h)}=F_{UL}^{\sin(2\phi_h)}/F_{UU}$  for 
 Jefferson Lab data from CLAS for neutral pion SIDIS \cite{Jawalkar:2017ube} are plotted in Fig.~\ref{aul_jlab}.
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.45\textwidth]{\FigPath/AULsin2phi_COMPASS_x.pdf}  (a)
\includegraphics[width=0.45\textwidth]{\FigPath/AULsin2phi_JLAB_x.pdf}  (b)
