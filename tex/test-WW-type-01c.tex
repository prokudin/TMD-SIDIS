...
\begin{figure}[b!]
\centering
\includegraphics[height=3.7cm]{\FigPath/UT_Pr10_pretzelosity_pip.pdf} {\tiny (a)}%
\includegraphics[height=3.7cm]{\FigPath/UT_Pr10_pretzelosity_pim.pdf} {\tiny (b)}%

 
\includegraphics[height=3.3cm]{\FigPath/AUTPretzelosity_HERMES_x.pdf}{\tiny (c)}%
\includegraphics[height=3.5cm]{\FigPath/AUTPretzelosity_x.pdf}{\tiny (d)}%
\caption{\label{aut_h1tp_jlab} $A_{UT}^{\sin(3 \phi_h - \phi_S)}$
	...
	\cite{Schnell:2010zza}(c) in comparison to the best fit from \cite{Lefky:2014eia}
	(whose 1-$\sigma$ uncertainty band is compatible with zero), and our calculation for COMPASS kinematics (d). For comparison the COMPASS plots
...
\begin{figure}[b!]
\centering
\includegraphics[height=3.5cm]{\FigPath/A_UL2_Pr0711_Zgt02.pdf} {\tiny (a)}
...
\includegraphics[height=3.5cm]{\FigPath/AULsin2phi_COMPASS_x} {\tiny (c)}
	...
	JLab \cite{Jawalkar:2017ube} (b),  and our calculation for COMPASS kinematics (c). Results
...
\includegraphics[height=3.5cm]{\FigPath/AUTsinphiS_HERMES_x.pdf}  {\tiny (c)}
\includegraphics[height=3.5cm]{\FigPath/AUTsinphiS_COMPASS_x}  {\tiny (d)}
\caption{\label{autsinphis}
	...
	and HERMES data \cite{Schnell:2010zza} (c), and our calculation for COMPASS kinematics (d).}
\end{figure}
...
\includegraphics[height=3.5cm]{\FigPath/AUTsin2PhiminusPhiS_HERMES_x.pdf} {\tiny (c)}
\includegraphics[height=3.5cm]{\FigPath/AUTsin2PhiminusPhiS_COMPASS_x} {\tiny (d)}
\caption{\label{autsin2phihphis}
	...
	preliminary HERMES data~\cite{Schnell:2010zza} (c), and our calculation for COMPASS kinematics (d).
	}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
