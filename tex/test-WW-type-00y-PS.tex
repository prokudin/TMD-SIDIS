...
\kt{Please note that, for now, the package can compute aforementioned observables
for proton target, detected charged pions and beam helicity $=-\frac{1}{2},
0,\frac{1}{2}$}. Make sure that you do not move \texttt{example.nb} to another directory 
