...
\preprint{\red{version ``01b''}; 14 Sep 2018; JLAB-THY-18-2775}
...
%\ps{(PS: \cite{Collins:2014jpa} ADDED)}
...
%
% ``and it was shown that evolution of higher twist operators is 
%   generically different from the leading twist ones.''
%
% PS: this comment (added by AP) is too trivial. OF COURSE is the
% evolution of twist-3 DIFFERENT from twist-2. Well known from colinear
% case! So no surprize it is different for TMDs. Not sure which point
% you would like to make. I propose to skip, or to make this point
% more specific.
% Remark: in early 1990s Braun-et-al derived evolution equations for 
% \tilde{g}_T(x), later Belitsky+Mueller derived evolution equations 
% for \tilde{h}_L, \tilde{e}_L. Highly complex evolution pattern
% (Mellin moments mix under evolution! Simple DGLAP only in large-Nc limit).
% People know this, do not expect any better for TMDs.
%
...
\ea
\ps{Here the} %with the understanding that
...
\begin{figure}[b!]
\centering
\includegraphics[height=3.7cm]{\FigPath/UT_Pr10_pretzelosity_pip.pdf}%
\includegraphics[height=3.7cm]{\FigPath/UT_Pr10_pretzelosity_pim.pdf}%
\includegraphics[height=3.5cm]{\FigPath/AUTPretzelosity_HERMES_x.pdf}%
...
\begin{figure}[h]
\centering
\includegraphics[width=0.35\textwidth]{\FigPath/LT_Pr10_cosphihphis_pip}
\includegraphics[width=0.35\textwidth]{\FigPath/LT_Pr10_cosphihphis_pim}
...
\begin{figure}[b!]
\centering
\includegraphics[height=3.5cm]{\FigPath/A_UL2_Pr0711_Zgt02.pdf} \ 
\includegraphics[height=3.5cm]{\FigPath/AULsin2phi_JLAB_x.pdf} 
	...
	COMPASS \cite{Parsamyan:2015dfa} (left panel), 
...
\cite{Parsamyan:2018ovx}, and JLab \cite{Avakian:2010ae,Jawalkar:2017ube}.
...
\begin{figure}[b!]
\centering
\includegraphics[width=0.35\textwidth]{\FigPath/LT_Pr10_cosphis_pip.pdf} 
\includegraphics[width=0.35\textwidth]{\FigPath/LT_Pr10_cosphis_pim.pdf} 
...
\begin{figure}[h]
\centering
\includegraphics[width=0.35\textwidth]{\FigPath/LT_Pr10_cos2phihphis_pip}
\includegraphics[width=0.35\textwidth]{\FigPath/LT_Pr10_cos2phihphis_pim} 
...
\cite{Parsamyan:2018ovx} (see Fig.~\ref{allcosphi_jlab}) and HERMES \cite{Airapetian:2018rlq} data.
...
%flavor dependence of this asymmetry. 
...
\begin{figure}[h]
\centering
\includegraphics[height=3.5cm]{\FigPath/UT_Pr10_sinphis_pip.pdf}
\includegraphics[height=3.5cm]{\FigPath/UT_Pr10_sinphis_pim.pdf}
\includegraphics[height=3.5cm]{\FigPath/AUTsinphiS_HERMES_x.pdf}
...
\begin{figure}[b]
\centering
\includegraphics[height=3.5cm]{\FigPath/UT_Pr10_sin2phihphis_pip}%
\includegraphics[height=3.5cm]{\FigPath/UT_Pr10_sin2phihphis_pip}%
\includegraphics[height=3.5cm]{\FigPath/AUTsin2PhiminusPhiS_HERMES_x.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.35\textwidth]{\FigPath/AUUcosphi_COMPASS_x.pdf} 
\includegraphics[width=0.35\textwidth]{\FigPath/AUUcosphi_HERMES_x.pdf}
